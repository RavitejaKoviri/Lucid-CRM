            ...
            {rows?.length > 0 ? (
              rows
                ?.filter((val: any) => {
                  ...
                  if (
                    val?.original?.company?.companyName
                      ?.toLowerCase()
                      ?.includes(searchTerm?.toLowerCase())
                  ) {
                    return val;
                  ...
                  if (
                    val?.original?.campaignSource?.campaignName
                      ?.toLowerCase()
                      ?.includes(searchTerm?.toLowerCase())
                  ) {
                    console.log(val, "val");
                  ...
                  if (
                    val?.original?.leadSource?.SourceName?.toLowerCase()?.includes(
