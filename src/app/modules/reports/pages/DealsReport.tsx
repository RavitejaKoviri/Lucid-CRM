...
import { getAllDeals } from '../_redux/reportsAction';
								...
								<div className="card-header align-items-center py-5 gap-2 gap-md-5">
									...
									<div className="card-title">
										...
										<div className="d-flex align-items-center position-relative my-1">
											...
											<input type="text" data-kt-ecommerce-order-filter="search" className="form-control form-control-solid w-250px ps-14" placeholder="Search Deal Report" onChange={(e)=>setSearch(e.currentTarget.value)}/>
										</div>
									...
									<table className="table align-middle table-row-dashed fs-6 gy-5" id="kt_ecommerce_report_customer_orders_table">
										...
										<thead>
											...
											<tr className="text-start text-gray-400 fw-bold fs-7 text-uppercase gs-0">
												<th className="min-w-100px">Deal Name</th>
												<th className="min-w-200px">Deal Contact Name</th>
