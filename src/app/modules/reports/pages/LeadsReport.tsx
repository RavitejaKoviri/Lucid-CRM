								...
								<div className="card-header align-items-center py-5 gap-2 gap-md-5">
									...
									<div className="card-title">
										...
										<div className="d-flex align-items-center position-relative my-1">
											...
											<input type="text" data-kt-ecommerce-order-filter="search" className="form-control form-control-solid w-250px ps-14" placeholder="Search Lead Report" onChange={(e) => setSearch(e.target.value)}/>
										</div>
