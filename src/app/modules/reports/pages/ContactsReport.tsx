...
import { getAllContacts } from '../_redux/reportsAction';
...
export function ContactsReport() {
  ...
  return (
    <div className="content d-flex flex-column flex-column-fluid" id="kt_content">
								...
								<div className="card-header align-items-center py-5 gap-2 gap-md-5">
									...
									<div className="card-title">
										...
										<div className="d-flex align-items-center position-relative my-1">
											...
											<input type="text" data-kt-ecommerce-order-filter="search" className="form-control form-control-solid w-250px ps-14" placeholder="Search Contact Report" onChange={(e) => setSearch(e.target.value)}/>
										</div>
                      ...
                      <th className="min-w-150px">Contact Name</th>
