...
import { getAllTasks } from '../_redux/reportsAction';
								...
								<div className="card-header align-items-center py-5 gap-2 gap-md-5">
									...
									<div className="card-title">
										...
										<div className="d-flex align-items-center position-relative my-1">
											...
											<input type="text" data-kt-ecommerce-order-filter="search" className="form-control form-control-solid w-250px ps-14" placeholder="Search Report By Subject" onChange={(e)=>setSearch(e.currentTarget.value)}/>
										</div>
									...
									<div className="card-toolbar flex-row-fluid justify-content-end gap-5">
										...
										<input className="form-control form-control-solid w-100 mw-250px" placeholder="Pick date range" id="kt_ecommerce_report_customer_orders_daterangepicker" />
									...
									<table className="table align-middle table-row-dashed fs-6 gy-5" id="kt_ecommerce_report_customer_orders_table">
										...
										<thead>
											...
											<tr className="text-start text-gray-400 fw-bold fs-7 text-uppercase gs-0">
												<th className="min-w-100px">Owner Name</th>
												...
												<th className="min-w-100px">Contact Email</th>
												<th className="min-w-150px">Contact Mobile</th>
												<th className="min-w-150px">Contact City</th>
												<th className="min-w-150px">Contact Company</th>
												<th className="min-w-150px">Contact JobTitle</th>
