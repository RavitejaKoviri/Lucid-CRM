...
import { initialUser, Campaign } from '../core/_models'
...
const CampaignEditModalForm: FC<Props> = ({ user, isUserLoading }) => {
  const { setItemIdForUpdate } = useListView()
  const { refetch } = useQueryResponse()

  const [userForEdit] = useState<Campaign>({
    ...user,
  ...
  return (
    <>
      ...
      {(formik.isSubmitting || isUserLoading) && <CampaignsListLoading />}
    </>
  )
}

export { CampaignEditModalForm }
