...
import { DeleteDeal, getAlldeals, getdealsById, UpdateDeal } from "../_redux/dealAction";
                  ...
                  <div className="d-flex flex-end mb-3">
                    ...
                    <div>
                      <button
                        type="button"
                        className="btn btn-sm btn-icon btn-color-light-dark btn-active-light-primary"
                        onClick={() => { navigation('dealsadduser', { state: { id } }) }}
                      >
                        {/* begin::Svg Icon | path: icons/duotune/general/gen024.svg */}
                    ...
                    <div>
                      <button
                        type="button"
                        className="btn btn-sm btn-icon btn-color-light-dark btn-active-light-primary"
                        onClick={() => { dispatch(DeleteDeal(id, token)); }}
                      >
                        {/* begin::Svg Icon | path: icons/duotune/general/gen024.svg */}
