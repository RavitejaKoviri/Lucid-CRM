...
const DealEditModalForm: FC<Props> = ({ user, isDealLoading }) => {
    ...
    <>
      <form id='kt_modal_add_user_form' className='form' onSubmit={formik.handleSubmit} noValidate>
			...
			<div className="page d-flex flex-row flex-column-fluid">
				...
				<div id="kt_aside" className="aside pb-5 pt-5 pt-lg-0" data-kt-drawer="true" data-kt-drawer-name="aside" data-kt-drawer-activate="{default: true, lg: false}" data-kt-drawer-overlay="true" data-kt-drawer-width="{default:'80px', '300px': '100px'}" data-kt-drawer-direction="start" data-kt-drawer-toggle="#kt_aside_mobile_toggle">
					...
					<div className="aside-logo py-8" id="kt_aside_logo">
						{/* {/*begin::Logo*/}
						<a href="../../demo6/dist/index.html" className="d-flex align-items-center">
							<img alt="Logo" src="assets/media/logos/demo6.svg" className="h-45px logo" />
						</a>
						{/* {/*end::Logo*/}
					</div>
					{/* {/*end::Brand*/}
					...
					<div className="aside-menu flex-column-fluid" id="kt_aside_menu">
						...
						<div className="hover-scroll-overlay-y my-2 my-lg-5 pe-lg-n1" id="kt_aside_menu_wrapper" data-kt-scroll="true" data-kt-scroll-height="auto" data-kt-scroll-dependencies="#kt_aside_logo, #kt_aside_footer" data-kt-scroll-wrappers="#kt_aside, #kt_aside_menu" data-kt-scroll-offset="5px">
							{/* {/*begin::Menu*/}
							<div className="menu menu-column menu-title-gray-700 menu-state-title-primary menu-state-icon-primary menu-state-bullet-primary menu-arrow-gray-500 fw-semibold" id="#kt_aside_menu" data-kt-menu="true">
								{/* {/*begin:Menu item*/}
								<div data-kt-menu-trigger="{default: 'click', lg: 'hover'}" data-kt-menu-placement="right-start" className="menu-item py-2">
									...
									<div className="menu-sub menu-sub-dropdown py-4 w-200px w-lg-225px">
										...
										<div className="menu-item">
											{/* {/*begin:Menu link*/}
											<a className="menu-link" href="../../demo6/dist/index.html">
										...
										<div className="menu-item">
											{/* {/*begin:Menu link*/}
											<a className="menu-link" href="../../demo6/dist/dashboards/ecommerce.html">
												<span className="menu-bullet">
													<span className="bullet bullet-dot"></span>
												</span>
										...
										<div className="menu-item">
											{/* {/*begin:Menu link*/}
											<a className="menu-link" href="../../demo6/dist/dashboards/projects.html">
												<span className="menu-bullet">
													<span className="bullet bullet-dot"></span>
												</span>
										...
										<div className="menu-item">
											{/* {/*begin:Menu link*/}
											<a className="menu-link" href="../../demo6/dist/dashboards/online-courses.html">
												<span className="menu-bullet">
													<span className="bullet bullet-dot"></span>
												</span>
										...
										<div className="menu-item">
											{/* {/*begin:Menu link*/}
											<a className="menu-link" href="../../demo6/dist/dashboards/marketing.html">
												<span className="menu-bullet">
													<span className="bullet bullet-dot"></span>
												</span>
										...
										<div className="menu-inner flex-column collapse" id="kt_app_sidebar_menu_dashboards_collapse">
											...
											<div className="menu-item">
												{/*begin:Menu link*/}
												<a className="menu-link" href="../../demo6/dist/dashboards/bidding.html">
													<span className="menu-bullet">
														<span className="bullet bullet-dot"></span>
													</span>
											...
											<div className="menu-item">
												{/*begin:Menu link*/}
												<a className="menu-link" href="../../demo6/dist/dashboards/pos.html">
													<span className="menu-bullet">
														<span className="bullet bullet-dot"></span>
													</span>
											...
											<div className="menu-item">
												{/*begin:Menu link*/}
												<a className="menu-link" href="../../demo6/dist/dashboards/call-center.html">
													<span className="menu-bullet">
														<span className="bullet bullet-dot"></span>
													</span>
											...
											<div className="menu-item">
												{/*begin:Menu link*/}
												<a className="menu-link" href="../../demo6/dist/dashboards/logistics.html">
													<span className="menu-bullet">
														<span className="bullet bullet-dot"></span>
													</span>
											...
											<div className="menu-item">
												{/*begin:Menu link*/}
												<a className="menu-link" href="../../demo6/dist/dashboards/website-analytics.html">
													<span className="menu-bullet">
														<span className="bullet bullet-dot"></span>
													</span>
											...
											<div className="menu-item">
												{/*begin:Menu link*/}
												<a className="menu-link" href="../../demo6/dist/dashboards/finance-performance.html">
													<span className="menu-bullet">
														<span className="bullet bullet-dot"></span>
													</span>
											...
											<div className="menu-item">
												{/*begin:Menu link*/}
												<a className="menu-link" href="../../demo6/dist/dashboards/store-analytics.html">
													<span className="menu-bullet">
														<span className="bullet bullet-dot"></span>
													</span>
											...
											<div className="menu-item">
												{/*begin:Menu link*/}
												<a className="menu-link" href="../../demo6/dist/dashboards/social.html">
													<span className="menu-bullet">
														<span className="bullet bullet-dot"></span>
													</span>
											...
											<div className="menu-item">
												{/*begin:Menu link*/}
												<a className="menu-link" href="../../demo6/dist/dashboards/delivery.html">
													<span className="menu-bullet">
														<span className="bullet bullet-dot"></span>
													</span>
											...
											<div className="menu-item">
												{/*begin:Menu link*/}
												<a className="menu-link" href="../../demo6/dist/dashboards/crypto.html">
													<span className="menu-bullet">
														<span className="bullet bullet-dot"></span>
													</span>
											...
											<div className="menu-item">
												{/*begin:Menu link*/}
												<a className="menu-link" href="../../demo6/dist/dashboards/school.html">
													<span className="menu-bullet">
														<span className="bullet bullet-dot"></span>
													</span>
											...
											<div className="menu-item">
												{/*begin:Menu link*/}
												<a className="menu-link" href="../../demo6/dist/dashboards/podcast.html">
													<span className="menu-bullet">
														<span className="bullet bullet-dot"></span>
													</span>
											...
											<div className="menu-item">
												{/*begin:Menu link*/}
												<a className="menu-link" href="../../demo6/dist/landing.html">
													<span className="menu-bullet">
														<span className="bullet bullet-dot"></span>
													</span>
									...
									<div className="menu-sub menu-sub-dropdown menu-sub-indention px-2 py-4 w-250px">
										...
										<div data-kt-menu-trigger="click" className="menu-item menu-accordion">
											...
											<div className="menu-sub menu-sub-accordion">
												...
												<div className="menu-item">
													{/*begin:Menu link*/}
													<a className="menu-link" href="../../demo6/dist/pages/user-profile/overview.html">
														<span className="menu-bullet">
															<span className="bullet bullet-dot"></span>
														</span>
												...
												<div className="menu-item">
													{/*begin:Menu link*/}
													<a className="menu-link" href="../../demo6/dist/pages/user-profile/projects.html">
														<span className="menu-bullet">
															<span className="bullet bullet-dot"></span>
														</span>
														<span className="menu-title">Projects</span>
												...
												<div className="menu-item">
													{/*begin:Menu link*/}
													<a className="menu-link" href="../../demo6/dist/pages/user-profile/campaigns.html">
														<span className="menu-bullet">
															<span className="bullet bullet-dot"></span>
														</span>
												...
												<div className="menu-item">
													{/*begin:Menu link*/}
													<a className="menu-link" href="../../demo6/dist/pages/user-profile/documents.html">
														<span className="menu-bullet">
															<span className="bullet bullet-dot"></span>
														</span>
												...
												<div className="menu-item">
													{/*begin:Menu link*/}
													<a className="menu-link" href="../../demo6/dist/pages/user-profile/followers.html">
														<span className="menu-bullet">
															<span className="bullet bullet-dot"></span>
														</span>
												...
												<div className="menu-item">
													{/*begin:Menu link*/}
													<a className="menu-link" href="../../demo6/dist/pages/user-profile/activity.html">
														<span className="menu-bullet">
															<span className="bullet bullet-dot"></span>
														</span>
										...
										<div data-kt-menu-trigger="click" className="menu-item menu-accordion">
											...
											<div className="menu-sub menu-sub-accordion">
												...
												<div className="menu-item">
													{/*begin:Menu link*/}
													<a className="menu-link" href="../../demo6/dist/account/overview.html">
														<span className="menu-bullet">
															<span className="bullet bullet-dot"></span>
														</span>
														<span className="menu-title">Overview</span>
												...
												<div className="menu-item">
													{/*begin:Menu link*/}
													<a className="menu-link" href="../../demo6/dist/account/settings.html">
														<span className="menu-bullet">
															<span className="bullet bullet-dot"></span>
														</span>
												...
												<div className="menu-item">
													{/*begin:Menu link*/}
													<a className="menu-link" href="../../demo6/dist/account/security.html">
														<span className="menu-bullet">
															<span className="bullet bullet-dot"></span>
														</span>
												...
												<div className="menu-item">
													{/*begin:Menu link*/}
													<a className="menu-link" href="../../demo6/dist/account/activity.html">
														<span className="menu-bullet">
															<span className="bullet bullet-dot"></span>
														</span>
														<span className="menu-title">Activity</span>
												...
												<div className="menu-item">
													{/*begin:Menu link*/}
													<a className="menu-link" href="../../demo6/dist/account/billing.html">
														<span className="menu-bullet">
															<span className="bullet bullet-dot"></span>
														</span>
												...
												<div className="menu-item">
													{/*begin:Menu link*/}
													<a className="menu-link" href="../../demo6/dist/account/statements.html">
														<span className="menu-bullet">
															<span className="bullet bullet-dot"></span>
														</span>
												...
												<div className="menu-item">
													{/*begin:Menu link*/}
													<a className="menu-link" href="../../demo6/dist/account/referrals.html">
														<span className="menu-bullet">
															<span className="bullet bullet-dot"></span>
														</span>
												...
												<div className="menu-item">
													{/*begin:Menu link*/}
													<a className="menu-link" href="../../demo6/dist/account/api-keys.html">
														<span className="menu-bullet">
															<span className="bullet bullet-dot"></span>
														</span>
												...
												<div className="menu-item">
													{/*begin:Menu link*/}
													<a className="menu-link" href="../../demo6/dist/account/logs.html">
														<span className="menu-bullet">
															<span className="bullet bullet-dot"></span>
														</span>
											...
											<div className="menu-sub menu-sub-accordion">
												...
												<div data-kt-menu-trigger="click" className="menu-item menu-accordion">
													...
													<div className="menu-sub menu-sub-accordion menu-active-bg">
														...
														<div className="menu-item">
															{/*begin:Menu link*/}
															<a className="menu-link" href="../../demo6/dist/authentication/layouts/corporate/sign-in.html">
																<span className="menu-bullet">
																	<span className="bullet bullet-dot"></span>
																</span>
														...
														<div className="menu-item">
															{/*begin:Menu link*/}
															<a className="menu-link" href="../../demo6/dist/authentication/layouts/corporate/sign-up.html">
																<span className="menu-bullet">
																	<span className="bullet bullet-dot"></span>
																</span>
														...
														<div className="menu-item">
															{/*begin:Menu link*/}
															<a className="menu-link" href="../../demo6/dist/authentication/layouts/corporate/two-steps.html">
																<span className="menu-bullet">
																	<span className="bullet bullet-dot"></span>
																</span>
														...
														<div className="menu-item">
															{/*begin:Menu link*/}
															<a className="menu-link" href="../../demo6/dist/authentication/layouts/corporate/reset-password.html">
																<span className="menu-bullet">
																	<span className="bullet bullet-dot"></span>
																</span>
														...
														<div className="menu-item">
															{/*begin:Menu link*/}
															<a className="menu-link" href="../../demo6/dist/authentication/layouts/corporate/new-password.html">
																<span className="menu-bullet">
																	<span className="bullet bullet-dot"></span>
																</span>
												...
												<div data-kt-menu-trigger="click" className="menu-item menu-accordion">
													...
													<div className="menu-sub menu-sub-accordion menu-active-bg">
														...
														<div className="menu-item">
															{/*begin:Menu link*/}
															<a className="menu-link" href="../../demo6/dist/authentication/layouts/overlay/sign-in.html">
																<span className="menu-bullet">
																	<span className="bullet bullet-dot"></span>
																</span>
																<span className="menu-title">Sign-in</span>
														...
														<div className="menu-item">
															{/*begin:Menu link*/}
															<a className="menu-link" href="../../demo6/dist/authentication/layouts/overlay/sign-up.html">
																<span className="menu-bullet">
																	<span className="bullet bullet-dot"></span>
																</span>
																<span className="menu-title">Sign-up</span>
														...
														<div className="menu-item">
															{/*begin:Menu link*/}
															<a className="menu-link" href="../../demo6/dist/authentication/layouts/overlay/two-steps.html">
																<span className="menu-bullet">
																	<span className="bullet bullet-dot"></span>
																</span>
																<span className="menu-title">Two-steps</span>
														...
														<div className="menu-item">
															{/*begin:Menu link*/}
															<a className="menu-link" href="../../demo6/dist/authentication/layouts/overlay/reset-password.html">
																<span className="menu-bullet">
																	<span className="bullet bullet-dot"></span>
																</span>
																<span className="menu-title">Reset Password</span>
														...
														<div className="menu-item">
															{/*begin:Menu link*/}
															<a className="menu-link" href="../../demo6/dist/authentication/layouts/overlay/new-password.html">
																<span className="menu-bullet">
																	<span className="bullet bullet-dot"></span>
																</span>
																<span className="menu-title">New Password</span>
												...
												<div data-kt-menu-trigger="click" className="menu-item menu-accordion">
													...
													<div className="menu-sub menu-sub-accordion menu-active-bg">
														...
														<div className="menu-item">
															{/*begin:Menu link*/}
															<a className="menu-link" href="../../demo6/dist/authentication/layouts/creative/sign-in.html">
																<span className="menu-bullet">
																	<span className="bullet bullet-dot"></span>
																</span>
																<span className="menu-title">Sign-in</span>
														...
														<div className="menu-item">
															{/*begin:Menu link*/}
															<a className="menu-link" href="../../demo6/dist/authentication/layouts/creative/sign-up.html">
																<span className="menu-bullet">
																	<span className="bullet bullet-dot"></span>
																</span>
																<span className="menu-title">Sign-up</span>
														...
														<div className="menu-item">
															{/*begin:Menu link*/}
															<a className="menu-link" href="../../demo6/dist/authentication/layouts/creative/two-steps.html">
																<span className="menu-bullet">
																	<span className="bullet bullet-dot"></span>
																</span>
																<span className="menu-title">Two-steps</span>
														...
														<div className="menu-item">
															{/*begin:Menu link*/}
															<a className="menu-link" href="../../demo6/dist/authentication/layouts/creative/reset-password.html">
																<span className="menu-bullet">
																	<span className="bullet bullet-dot"></span>
																</span>
																<span className="menu-title">Reset Password</span>
														...
														<div className="menu-item">
															{/*begin:Menu link*/}
															<a className="menu-link" href="../../demo6/dist/authentication/layouts/creative/new-password.html">
																<span className="menu-bullet">
																	<span className="bullet bullet-dot"></span>
																</span>
																<span className="menu-title">New Password</span>
												...
												<div data-kt-menu-trigger="click" className="menu-item menu-accordion">
													...
													<div className="menu-sub menu-sub-accordion menu-active-bg">
														...
														<div className="menu-item">
															{/*begin:Menu link*/}
															<a className="menu-link" href="../../demo6/dist/authentication/layouts/fancy/sign-in.html">
																<span className="menu-bullet">
																	<span className="bullet bullet-dot"></span>
																</span>
																<span className="menu-title">Sign-in</span>
														...
														<div className="menu-item">
															{/*begin:Menu link*/}
															<a className="menu-link" href="../../demo6/dist/authentication/layouts/fancy/sign-up.html">
																<span className="menu-bullet">
																	<span className="bullet bullet-dot"></span>
																</span>
																<span className="menu-title">Sign-up</span>
														...
														<div className="menu-item">
															{/*begin:Menu link*/}
															<a className="menu-link" href="../../demo6/dist/authentication/layouts/fancy/two-steps.html">
																<span className="menu-bullet">
																	<span className="bullet bullet-dot"></span>
																</span>
																<span className="menu-title">Two-steps</span>
														...
														<div className="menu-item">
															{/*begin:Menu link*/}
															<a className="menu-link" href="../../demo6/dist/authentication/layouts/fancy/reset-password.html">
																<span className="menu-bullet">
																	<span className="bullet bullet-dot"></span>
																</span>
																<span className="menu-title">Reset Password</span>
														...
														<div className="menu-item">
															{/*begin:Menu link*/}
															<a className="menu-link" href="../../demo6/dist/authentication/layouts/fancy/new-password.html">
																<span className="menu-bullet">
																	<span className="bullet bullet-dot"></span>
																</span>
																<span className="menu-title">New Password</span>
												...
												<div data-kt-menu-trigger="click" className="menu-item menu-accordion">
													...
													<div className="menu-sub menu-sub-accordion menu-active-bg">
														...
														<div className="menu-item">
															{/*begin:Menu link*/}
															<a className="menu-link" href="../../demo6/dist/authentication/email/welcome-message.html">
																<span className="menu-bullet">
																	<span className="bullet bullet-dot"></span>
																</span>
														...
														<div className="menu-item">
															{/*begin:Menu link*/}
															<a className="menu-link" href="../../demo6/dist/authentication/email/reset-password.html">
																<span className="menu-bullet">
																	<span className="bullet bullet-dot"></span>
																</span>
																<span className="menu-title">Reset Password</span>
														...
														<div className="menu-item">
															{/*begin:Menu link*/}
															<a className="menu-link" href="../../demo6/dist/authentication/email/subscription-confirmed.html">
																<span className="menu-bullet">
																	<span className="bullet bullet-dot"></span>
																</span>
														...
														<div className="menu-item">
															{/*begin:Menu link*/}
															<a className="menu-link" href="../../demo6/dist/authentication/email/card-declined.html">
																<span className="menu-bullet">
																	<span className="bullet bullet-dot"></span>
																</span>
														...
														<div className="menu-item">
															{/*begin:Menu link*/}
															<a className="menu-link" href="../../demo6/dist/authentication/email/promo-1.html">
																<span className="menu-bullet">
																	<span className="bullet bullet-dot"></span>
																</span>
														...
														<div className="menu-item">
															{/*begin:Menu link*/}
															<a className="menu-link" href="../../demo6/dist/authentication/email/promo-2.html">
																<span className="menu-bullet">
																	<span className="bullet bullet-dot"></span>
																</span>
														...
														<div className="menu-item">
															{/*begin:Menu link*/}
															<a className="menu-link" href="../../demo6/dist/authentication/email/promo-3.html">
																<span className="menu-bullet">
																	<span className="bullet bullet-dot"></span>
																</span>
												...
												<div className="menu-item">
													{/*begin:Menu link*/}
													<a className="menu-link" href="../../demo6/dist/authentication/extended/multi-steps-sign-up.html">
														<span className="menu-bullet">
															<span className="bullet bullet-dot"></span>
														</span>
												...
												<div className="menu-item">
													{/*begin:Menu link*/}
													<a className="menu-link" href="../../demo6/dist/authentication/extended/two-factor-auth.html">
														<span className="menu-bullet">
															<span className="bullet bullet-dot"></span>
														</span>
												...
												<div className="menu-item">
													{/*begin:Menu link*/}
													<a className="menu-link" href="../../demo6/dist/authentication/general/welcome.html">
														<span className="menu-bullet">
															<span className="bullet bullet-dot"></span>
														</span>
														<span className="menu-title">Welcome Message</span>
												...
												<div className="menu-item">
													{/*begin:Menu link*/}
													<a className="menu-link" href="../../demo6/dist/authentication/general/verify-email.html">
														<span className="menu-bullet">
															<span className="bullet bullet-dot"></span>
														</span>
												...
												<div className="menu-item">
													{/*begin:Menu link*/}
													<a className="menu-link" href="../../demo6/dist/authentication/general/coming-soon.html">
														<span className="menu-bullet">
															<span className="bullet bullet-dot"></span>
														</span>
												...
												<div className="menu-item">
													{/*begin:Menu link*/}
													<a className="menu-link" href="../../demo6/dist/authentication/general/password-confirmation.html">
														<span className="menu-bullet">
															<span className="bullet bullet-dot"></span>
														</span>
												...
												<div className="menu-item">
													{/*begin:Menu link*/}
													<a className="menu-link" href="../../demo6/dist/authentication/general/account-deactivated.html">
														<span className="menu-bullet">
															<span className="bullet bullet-dot"></span>
														</span>
												...
												<div className="menu-item">
													{/*begin:Menu link*/}
													<a className="menu-link" href="../../demo6/dist/authentication/general/error-404.html">
														<span className="menu-bullet">
															<span className="bullet bullet-dot"></span>
														</span>
												...
												<div className="menu-item">
													{/*begin:Menu link*/}
													<a className="menu-link" href="../../demo6/dist/authentication/general/error-500.html">
														<span className="menu-bullet">
															<span className="bullet bullet-dot"></span>
														</span>
										...
										<div data-kt-menu-trigger="click" className="menu-item menu-accordion">
											...
											<div className="menu-sub menu-sub-accordion">
												...
												<div className="menu-item">
													{/*begin:Menu link*/}
													<a className="menu-link" href="../../demo6/dist/pages/about.html">
														<span className="menu-bullet">
															<span className="bullet bullet-dot"></span>
														</span>
												...
												<div className="menu-item">
													{/*begin:Menu link*/}
													<a className="menu-link" href="../../demo6/dist/pages/team.html">
														<span className="menu-bullet">
															<span className="bullet bullet-dot"></span>
														</span>
												...
												<div className="menu-item">
													{/*begin:Menu link*/}
													<a className="menu-link" href="../../demo6/dist/pages/contact.html">
														<span className="menu-bullet">
															<span className="bullet bullet-dot"></span>
														</span>
												...
												<div className="menu-item">
													{/*begin:Menu link*/}
													<a className="menu-link" href="../../demo6/dist/pages/licenses.html">
														<span className="menu-bullet">
															<span className="bullet bullet-dot"></span>
														</span>
												...
												<div className="menu-item">
													{/*begin:Menu link*/}
													<a className="menu-link" href="../../demo6/dist/pages/sitemap.html">
														<span className="menu-bullet">
															<span className="bullet bullet-dot"></span>
														</span>
										...
										<div data-kt-menu-trigger="click" className="menu-item menu-accordion">
											...
											<div className="menu-sub menu-sub-accordion">
												...
												<div className="menu-item">
													{/*begin:Menu link*/}
													<a className="menu-link" href="../../demo6/dist/pages/social/feeds.html">
														<span className="menu-bullet">
															<span className="bullet bullet-dot"></span>
														</span>
												...
												<div className="menu-item">
													{/*begin:Menu link*/}
													<a className="menu-link" href="../../demo6/dist/pages/social/activity.html">
														<span className="menu-bullet">
															<span className="bullet bullet-dot"></span>
														</span>
												...
												<div className="menu-item">
													{/*begin:Menu link*/}
													<a className="menu-link" href="../../demo6/dist/pages/social/followers.html">
														<span className="menu-bullet">
															<span className="bullet bullet-dot"></span>
														</span>
														<span className="menu-title">Followers</span>
												...
												<div className="menu-item">
													{/*begin:Menu link*/}
													<a className="menu-link" href="../../demo6/dist/pages/social/settings.html">
														<span className="menu-bullet">
															<span className="bullet bullet-dot"></span>
														</span>
														<span className="menu-title">Settings</span>
										...
										<div data-kt-menu-trigger="click" className="menu-item menu-accordion">
											...
											<div className="menu-sub menu-sub-accordion">
												...
												<div className="menu-item">
													{/*begin:Menu link*/}
													<a className="menu-link" href="../../demo6/dist/pages/blog/home.html">
														<span className="menu-bullet">
															<span className="bullet bullet-dot"></span>
														</span>
												...
												<div className="menu-item">
													{/*begin:Menu link*/}
													<a className="menu-link" href="../../demo6/dist/pages/blog/post.html">
														<span className="menu-bullet">
															<span className="bullet bullet-dot"></span>
														</span>
										...
										<div data-kt-menu-trigger="click" className="menu-item menu-accordion">
											...
											<div className="menu-sub menu-sub-accordion">
												...
												<div className="menu-item">
													{/*begin:Menu link*/}
													<a className="menu-link" href="../../demo6/dist/pages/careers/list.html">
														<span className="menu-bullet">
															<span className="bullet bullet-dot"></span>
														</span>
												...
												<div className="menu-item">
													{/*begin:Menu link*/}
													<a className="menu-link" href="../../demo6/dist/pages/careers/apply.html">
														<span className="menu-bullet">
															<span className="bullet bullet-dot"></span>
														</span>
									...
									<div className="menu-sub menu-sub-dropdown menu-sub-indention px-2 py-4 w-200px w-lg-225px">
											...
											<div className="menu-sub menu-sub-accordion menu-active-bg">
												...
												<div data-kt-menu-trigger="click" className="menu-item menu-accordion">
													...
													<div className="menu-sub menu-sub-accordion menu-active-bg">
														...
														<div className="menu-item">
															{/*begin:Menu link*/}
															<a className="menu-link" href="../../demo6/dist/utilities/modals/general/invite-friends.html">
																<span className="menu-bullet">
																	<span className="bullet bullet-dot"></span>
																</span>
														...
														<div className="menu-item">
															{/*begin:Menu link*/}
															<a className="menu-link" href="../../demo6/dist/utilities/modals/general/view-users.html">
																<span className="menu-bullet">
																	<span className="bullet bullet-dot"></span>
																</span>
														...
														<div className="menu-item">
															{/*begin:Menu link*/}
															<a className="menu-link" href="../../demo6/dist/utilities/modals/general/select-users.html">
																<span className="menu-bullet">
																	<span className="bullet bullet-dot"></span>
																</span>
														...
														<div className="menu-item">
															{/*begin:Menu link*/}
															<a className="menu-link" href="../../demo6/dist/utilities/modals/general/upgrade-plan.html">
																<span className="menu-bullet">
																	<span className="bullet bullet-dot"></span>
																</span>
														...
														<div className="menu-item">
															{/*begin:Menu link*/}
															<a className="menu-link" href="../../demo6/dist/utilities/modals/general/share-earn.html">
																<span className="menu-bullet">
																	<span className="bullet bullet-dot"></span>
																</span>
												...
												<div data-kt-menu-trigger="click" className="menu-item menu-accordion">
													...
													<div className="menu-sub menu-sub-accordion menu-active-bg">
														...
														<div className="menu-item">
															{/*begin:Menu link*/}
															<a className="menu-link" href="../../demo6/dist/utilities/modals/forms/new-target.html">
																<span className="menu-bullet">
																	<span className="bullet bullet-dot"></span>
																</span>
														...
														<div className="menu-item">
															{/*begin:Menu link*/}
															<a className="menu-link" href="../../demo6/dist/utilities/modals/forms/new-card.html">
																<span className="menu-bullet">
																	<span className="bullet bullet-dot"></span>
																</span>
														...
														<div className="menu-item">
															{/*begin:Menu link*/}
															<a className="menu-link" href="../../demo6/dist/utilities/modals/forms/new-address.html">
																<span className="menu-bullet">
																	<span className="bullet bullet-dot"></span>
																</span>
														...
														<div className="menu-item">
															{/*begin:Menu link*/}
															<a className="menu-link" href="../../demo6/dist/utilities/modals/forms/create-api-key.html">
																<span className="menu-bullet">
																	<span className="bullet bullet-dot"></span>
																</span>
														...
														<div className="menu-item">
															{/*begin:Menu link*/}
															<a className="menu-link" href="../../demo6/dist/utilities/modals/forms/bidding.html">
																<span className="menu-bullet">
																	<span className="bullet bullet-dot"></span>
																</span>
																<span className="menu-title">Bidding</span>
												...
												<div data-kt-menu-trigger="click" className="menu-item menu-accordion">
													...
													<div className="menu-sub menu-sub-accordion menu-active-bg">
														...
														<div className="menu-item">
															{/*begin:Menu link*/}
															<a className="menu-link" href="../../demo6/dist/utilities/modals/wizards/create-app.html">
																<span className="menu-bullet">
																	<span className="bullet bullet-dot"></span>
																</span>
														...
														<div className="menu-item">
															{/*begin:Menu link*/}
															<a className="menu-link" href="../../demo6/dist/utilities/modals/wizards/create-campaign.html">
																<span className="menu-bullet">
																	<span className="bullet bullet-dot"></span>
																</span>
														...
														<div className="menu-item">
															{/*begin:Menu link*/}
															<a className="menu-link" href="../../demo6/dist/utilities/modals/wizards/create-account.html">
																<span className="menu-bullet">
																	<span className="bullet bullet-dot"></span>
																</span>
														...
														<div className="menu-item">
															{/*begin:Menu link*/}
															<a className="menu-link" href="../../demo6/dist/utilities/modals/wizards/create-project.html">
																<span className="menu-bullet">
																	<span className="bullet bullet-dot"></span>
																</span>
														...
														<div className="menu-item">
															{/*begin:Menu link*/}
															<a className="menu-link" href="../../demo6/dist/utilities/modals/wizards/top-up-wallet.html">
																<span className="menu-bullet">
																	<span className="bullet bullet-dot"></span>
																</span>
														...
														<div className="menu-item">
															{/*begin:Menu link*/}
															<a className="menu-link" href="../../demo6/dist/utilities/modals/wizards/offer-a-deal.html">
																<span className="menu-bullet">
																	<span className="bullet bullet-dot"></span>
																</span>
														...
														<div className="menu-item">
															{/*begin:Menu link*/}
															<a className="menu-link" href="../../demo6/dist/utilities/modals/wizards/two-factor-authentication.html">
																<span className="menu-bullet">
																	<span className="bullet bullet-dot"></span>
																</span>
																<span className="menu-title">Two Factor Auth</span>
												...
												<div data-kt-menu-trigger="click" className="menu-item menu-accordion">
													...
													<div className="menu-sub menu-sub-accordion menu-active-bg">
														...
														<div className="menu-item">
															{/*begin:Menu link*/}
															<a className="menu-link" href="../../demo6/dist/utilities/modals/search/users.html">
																<span className="menu-bullet">
																	<span className="bullet bullet-dot"></span>
																</span>
														...
														<div className="menu-item">
															{/*begin:Menu link*/}
															<a className="menu-link" href="../../demo6/dist/utilities/modals/search/select-location.html">
																<span className="menu-bullet">
																	<span className="bullet bullet-dot"></span>
																</span>
										...
										<div data-kt-menu-trigger="click" className="menu-item menu-accordion">
											...
											<div className="menu-sub menu-sub-accordion menu-active-bg">
												...
												<div className="menu-item">
													{/*begin:Menu link*/}
													<a className="menu-link" href="../../demo6/dist/utilities/wizards/horizontal.html">
														<span className="menu-bullet">
															<span className="bullet bullet-dot"></span>
														</span>
												...
												<div className="menu-item">
													{/*begin:Menu link*/}
													<a className="menu-link" href="../../demo6/dist/utilities/wizards/vertical.html">
														<span className="menu-bullet">
															<span className="bullet bullet-dot"></span>
														</span>
												...
												<div className="menu-item">
													{/*begin:Menu link*/}
													<a className="menu-link" href="../../demo6/dist/utilities/wizards/two-factor-authentication.html">
														<span className="menu-bullet">
															<span className="bullet bullet-dot"></span>
														</span>
														<span className="menu-title">Two Factor Auth</span>
												...
												<div className="menu-item">
													{/*begin:Menu link*/}
													<a className="menu-link" href="../../demo6/dist/utilities/wizards/create-app.html">
														<span className="menu-bullet">
															<span className="bullet bullet-dot"></span>
														</span>
														<span className="menu-title">Create App</span>
												...
												<div className="menu-item">
													{/*begin:Menu link*/}
													<a className="menu-link" href="../../demo6/dist/utilities/wizards/create-campaign.html">
														<span className="menu-bullet">
															<span className="bullet bullet-dot"></span>
														</span>
														<span className="menu-title">Create Campaign</span>
												...
												<div className="menu-item">
													{/*begin:Menu link*/}
													<a className="menu-link" href="../../demo6/dist/utilities/wizards/create-account.html">
														<span className="menu-bullet">
															<span className="bullet bullet-dot"></span>
														</span>
												...
												<div className="menu-item">
													{/*begin:Menu link*/}
													<a className="menu-link" href="../../demo6/dist/utilities/wizards/create-project.html">
														<span className="menu-bullet">
															<span className="bullet bullet-dot"></span>
														</span>
														<span className="menu-title">Create Project</span>
												...
												<div className="menu-item">
													{/*begin:Menu link*/}
													<a className="menu-link" href="../../demo6/dist/utilities/wizards/offer-a-deal.html">
														<span className="menu-bullet">
															<span className="bullet bullet-dot"></span>
														</span>
														<span className="menu-title">Offer a Deal</span>
										...
										<div data-kt-menu-trigger="click" className="menu-item menu-accordion">
											...
											<div className="menu-sub menu-sub-accordion menu-active-bg">
												...
												<div className="menu-item">
													{/*begin:Menu link*/}
													<a className="menu-link" href="../../demo6/dist/utilities/search/horizontal.html">
														<span className="menu-bullet">
															<span className="bullet bullet-dot"></span>
														</span>
														<span className="menu-title">Horizontal</span>
												...
												<div className="menu-item">
													{/*begin:Menu link*/}
													<a className="menu-link" href="../../demo6/dist/utilities/search/vertical.html">
														<span className="menu-bullet">
															<span className="bullet bullet-dot"></span>
														</span>
														<span className="menu-title">Vertical</span>
												...
												<div className="menu-item">
													{/*begin:Menu link*/}
													<a className="menu-link" href="../../demo6/dist/utilities/search/users.html">
														<span className="menu-bullet">
															<span className="bullet bullet-dot"></span>
														</span>
														<span className="menu-title">Users</span>
												...
												<div className="menu-item">
													{/*begin:Menu link*/}
													<a className="menu-link" href="../../demo6/dist/utilities/search/select-location.html">
														<span className="menu-bullet">
															<span className="bullet bullet-dot"></span>
														</span>
								...
								<div data-kt-menu-trigger="{default: 'click', lg: 'hover'}" data-kt-menu-placement="right-start" className="menu-item here show py-2">
									...
									<span className="menu-link menu-center">
										<span className="menu-icon me-0">
											<i className="fonticon-app-store fs-1"></i>
										</span>
									...
									<div className="menu-sub menu-sub-dropdown menu-sub-indention px-2 py-4 w-250px">
										...
										<div data-kt-menu-trigger="click" className="menu-item menu-accordion">
											...
											<div className="menu-sub menu-sub-accordion">
												...
												<div className="menu-item">
													{/*begin:Menu link*/}
													<a className="menu-link" href="../../demo6/dist/apps/projects/list.html">
														<span className="menu-bullet">
															<span className="bullet bullet-dot"></span>
														</span>
												...
												<div className="menu-item">
													{/*begin:Menu link*/}
													<a className="menu-link" href="../../demo6/dist/apps/projects/project.html">
														<span className="menu-bullet">
															<span className="bullet bullet-dot"></span>
														</span>
												...
												<div className="menu-item">
													{/*begin:Menu link*/}
													<a className="menu-link" href="../../demo6/dist/apps/projects/targets.html">
														<span className="menu-bullet">
															<span className="bullet bullet-dot"></span>
														</span>
												...
												<div className="menu-item">
													{/*begin:Menu link*/}
													<a className="menu-link" href="../../demo6/dist/apps/projects/budget.html">
														<span className="menu-bullet">
															<span className="bullet bullet-dot"></span>
														</span>
												...
												<div className="menu-item">
													{/*begin:Menu link*/}
													<a className="menu-link" href="../../demo6/dist/apps/projects/users.html">
														<span className="menu-bullet">
															<span className="bullet bullet-dot"></span>
														</span>
														<span className="menu-title">Users</span>
												...
												<div className="menu-item">
													{/*begin:Menu link*/}
													<a className="menu-link" href="../../demo6/dist/apps/projects/files.html">
														<span className="menu-bullet">
															<span className="bullet bullet-dot"></span>
														</span>
												...
												<div className="menu-item">
													{/*begin:Menu link*/}
													<a className="menu-link" href="../../demo6/dist/apps/projects/activity.html">
														<span className="menu-bullet">
															<span className="bullet bullet-dot"></span>
														</span>
														<span className="menu-title">Activity</span>
												...
												<div className="menu-item">
													{/*begin:Menu link*/}
													<a className="menu-link" href="../../demo6/dist/apps/projects/settings.html">
														<span className="menu-bullet">
															<span className="bullet bullet-dot"></span>
														</span>
														<span className="menu-title">Settings</span>
											...
											<div className="menu-sub menu-sub-accordion">
												...
												<div data-kt-menu-trigger="click" className="menu-item here show menu-accordion">
													...
													<div className="menu-sub menu-sub-accordion">
														...
														<div className="menu-item">
															{/*begin:Menu link*/}
															<a className="menu-link" href="../../demo6/dist/apps/ecommerce/catalog/products.html">
																<span className="menu-bullet">
																	<span className="bullet bullet-dot"></span>
																</span>
														...
														<div className="menu-item">
															{/*begin:Menu link*/}
															<a className="menu-link" href="../../demo6/dist/apps/ecommerce/catalog/categories.html">
																<span className="menu-bullet">
																	<span className="bullet bullet-dot"></span>
																</span>
														...
														<div className="menu-item">
															{/*begin:Menu link*/}
															<a className="menu-link active" href="../../demo6/dist/apps/ecommerce/catalog/add-product.html">
																<span className="menu-bullet">
																	<span className="bullet bullet-dot"></span>
																</span>
														...
														<div className="menu-item">
															{/*begin:Menu link*/}
															<a className="menu-link" href="../../demo6/dist/apps/ecommerce/catalog/edit-product.html">
																<span className="menu-bullet">
																	<span className="bullet bullet-dot"></span>
																</span>
														...
														<div className="menu-item">
															{/*begin:Menu link*/}
															<a className="menu-link" href="../../demo6/dist/apps/ecommerce/catalog/add-category.html">
																<span className="menu-bullet">
																	<span className="bullet bullet-dot"></span>
																</span>
														...
														<div className="menu-item">
															{/*begin:Menu link*/}
															<a className="menu-link" href="../../demo6/dist/apps/ecommerce/catalog/edit-category.html">
																<span className="menu-bullet">
																	<span className="bullet bullet-dot"></span>
																</span>
												...
												<div data-kt-menu-trigger="click" className="menu-item menu-accordion">
													...
													<div className="menu-sub menu-sub-accordion">
														...
														<div className="menu-item">
															{/*begin:Menu link*/}
															<a className="menu-link" href="../../demo6/dist/apps/ecommerce/sales/listing.html">
																<span className="menu-bullet">
																	<span className="bullet bullet-dot"></span>
																</span>
														...
														<div className="menu-item">
															{/*begin:Menu link*/}
															<a className="menu-link" href="../../demo6/dist/apps/ecommerce/sales/details.html">
																<span className="menu-bullet">
																	<span className="bullet bullet-dot"></span>
																</span>
														...
														<div className="menu-item">
															{/*begin:Menu link*/}
															<a className="menu-link" href="../../demo6/dist/apps/ecommerce/sales/add-order.html">
																<span className="menu-bullet">
																	<span className="bullet bullet-dot"></span>
																</span>
														...
														<div className="menu-item">
															{/*begin:Menu link*/}
															<a className="menu-link" href="../../demo6/dist/apps/ecommerce/sales/edit-order.html">
																<span className="menu-bullet">
																	<span className="bullet bullet-dot"></span>
																</span>
												...
												<div data-kt-menu-trigger="click" className="menu-item menu-accordion">
													...
													<div className="menu-sub menu-sub-accordion">
														...
														<div className="menu-item">
															{/*begin:Menu link*/}
															<a className="menu-link" href="../../demo6/dist/apps/ecommerce/customers/listing.html">
																<span className="menu-bullet">
																	<span className="bullet bullet-dot"></span>
																</span>
														...
														<div className="menu-item">
															{/*begin:Menu link*/}
															<a className="menu-link" href="../../demo6/dist/apps/ecommerce/customers/details.html">
																<span className="menu-bullet">
																	<span className="bullet bullet-dot"></span>
																</span>
												...
												<div data-kt-menu-trigger="click" className="menu-item menu-accordion">
													...
													<div className="menu-sub menu-sub-accordion">
														...
														<div className="menu-item">
															{/*begin:Menu link*/}
															<a className="menu-link" href="../../demo6/dist/apps/ecommerce/reports/view.html">
																<span className="menu-bullet">
																	<span className="bullet bullet-dot"></span>
																</span>
														...
														<div className="menu-item">
															{/*begin:Menu link*/}
															<a className="menu-link" href="../../demo6/dist/apps/ecommerce/reports/sales.html">
																<span className="menu-bullet">
																	<span className="bullet bullet-dot"></span>
																</span>
																<span className="menu-title">Sales</span>
														...
														<div className="menu-item">
															{/*begin:Menu link*/}
															<a className="menu-link" href="../../demo6/dist/apps/ecommerce/reports/returns.html">
																<span className="menu-bullet">
																	<span className="bullet bullet-dot"></span>
																</span>
														...
														<div className="menu-item">
															{/*begin:Menu link*/}
															<a className="menu-link" href="../../demo6/dist/apps/ecommerce/reports/customer-orders.html">
																<span className="menu-bullet">
																	<span className="bullet bullet-dot"></span>
																</span>
														...
														<div className="menu-item">
															{/*begin:Menu link*/}
															<a className="menu-link" href="../../demo6/dist/apps/ecommerce/reports/shipping.html">
																<span className="menu-bullet">
																	<span className="bullet bullet-dot"></span>
																</span>
												...
												<div className="menu-item">
													{/*begin:Menu link*/}
													<a className="menu-link" href="../../demo6/dist/apps/ecommerce/settings.html">
														<span className="menu-bullet">
															<span className="bullet bullet-dot"></span>
														</span>
														<span className="menu-title">Settings</span>
										...
										<div data-kt-menu-trigger="click" className="menu-item menu-accordion">
											...
											<div className="menu-sub menu-sub-accordion">
												...
												<div className="menu-item">
													{/*begin:Menu link*/}
													<a className="menu-link" href="../../demo6/dist/apps/contacts/getting-started.html">
														<span className="menu-bullet">
															<span className="bullet bullet-dot"></span>
														</span>
												...
												<div className="menu-item">
													{/*begin:Menu link*/}
													<a className="menu-link" href="../../demo6/dist/apps/contacts/add-contact.html">
														<span className="menu-bullet">
															<span className="bullet bullet-dot"></span>
														</span>
												...
												<div className="menu-item">
													{/*begin:Menu link*/}
													<a className="menu-link" href="../../demo6/dist/apps/contacts/edit-contact.html">
														<span className="menu-bullet">
															<span className="bullet bullet-dot"></span>
														</span>
												...
												<div className="menu-item">
													{/*begin:Menu link*/}
													<a className="menu-link" href="../../demo6/dist/apps/contacts/view-contact.html">
														<span className="menu-bullet">
															<span className="bullet bullet-dot"></span>
														</span>
										...
										<div data-kt-menu-trigger="click" className="menu-item menu-accordion">
											...
											<div className="menu-sub menu-sub-accordion">
												...
												<div className="menu-item">
													{/*begin:Menu link*/}
													<a className="menu-link" href="../../demo6/dist/apps/support-center/overview.html">
														<span className="menu-bullet">
															<span className="bullet bullet-dot"></span>
														</span>
														<span className="menu-title">Overview</span>
												...
												<div data-kt-menu-trigger="click" className="menu-item menu-accordion mb-1">
													...
													<div className="menu-sub menu-sub-accordion">
														...
														<div className="menu-item">
															{/*begin:Menu link*/}
															<a className="menu-link" href="../../demo6/dist/apps/support-center/tickets/list.html">
																<span className="menu-bullet">
																	<span className="bullet bullet-dot"></span>
																</span>
														...
														<div className="menu-item">
															{/*begin:Menu link*/}
															<a className="menu-link" href="../../demo6/dist/apps/support-center/tickets/view.html">
																<span className="menu-bullet">
																	<span className="bullet bullet-dot"></span>
																</span>
												...
												<div data-kt-menu-trigger="click" className="menu-item menu-accordion mb-1">
													...
													<div className="menu-sub menu-sub-accordion">
														...
														<div className="menu-item">
															{/*begin:Menu link*/}
															<a className="menu-link" href="../../demo6/dist/apps/support-center/tutorials/list.html">
																<span className="menu-bullet">
																	<span className="bullet bullet-dot"></span>
																</span>
														...
														<div className="menu-item">
															{/*begin:Menu link*/}
															<a className="menu-link" href="../../demo6/dist/apps/support-center/tutorials/post.html">
																<span className="menu-bullet">
																	<span className="bullet bullet-dot"></span>
																</span>
												...
												<div className="menu-item">
													{/*begin:Menu link*/}
													<a className="menu-link" href="../../demo6/dist/apps/support-center/faq.html">
														<span className="menu-bullet">
															<span className="bullet bullet-dot"></span>
														</span>
												...
												<div className="menu-item">
													{/*begin:Menu link*/}
													<a className="menu-link" href="../../demo6/dist/apps/support-center/licenses.html">
														<span className="menu-bullet">
															<span className="bullet bullet-dot"></span>
														</span>
														<span className="menu-title">Licenses</span>
												...
												<div className="menu-item">
													{/*begin:Menu link*/}
													<a className="menu-link" href="../../demo6/dist/apps/support-center/contact.html">
														<span className="menu-bullet">
															<span className="bullet bullet-dot"></span>
														</span>
														<span className="menu-title">Contact Us</span>
											...
											<div className="menu-sub menu-sub-accordion">
												...
												<div data-kt-menu-trigger="click" className="menu-item menu-accordion mb-1">
													...
													<div className="menu-sub menu-sub-accordion">
														...
														<div className="menu-item">
															{/*begin:Menu link*/}
															<a className="menu-link" href="../../demo6/dist/apps/user-management/users/list.html">
																<span className="menu-bullet">
																	<span className="bullet bullet-dot"></span>
																</span>
														...
														<div className="menu-item">
															{/*begin:Menu link*/}
															<a className="menu-link" href="../../demo6/dist/apps/user-management/users/view.html">
																<span className="menu-bullet">
																	<span className="bullet bullet-dot"></span>
																</span>
												...
												<div data-kt-menu-trigger="click" className="menu-item menu-accordion">
													...
													<div className="menu-sub menu-sub-accordion">
														...
														<div className="menu-item">
															{/*begin:Menu link*/}
															<a className="menu-link" href="../../demo6/dist/apps/user-management/roles/list.html">
																<span className="menu-bullet">
																	<span className="bullet bullet-dot"></span>
																</span>
														...
														<div className="menu-item">
															{/*begin:Menu link*/}
															<a className="menu-link" href="../../demo6/dist/apps/user-management/roles/view.html">
																<span className="menu-bullet">
																	<span className="bullet bullet-dot"></span>
																</span>
												...
												<div className="menu-item">
													{/*begin:Menu link*/}
													<a className="menu-link" href="../../demo6/dist/apps/user-management/permissions.html">
														<span className="menu-bullet">
															<span className="bullet bullet-dot"></span>
														</span>
										...
										<div data-kt-menu-trigger="click" className="menu-item menu-accordion">
											...
											<div className="menu-sub menu-sub-accordion">
												...
												<div className="menu-item">
													{/*begin:Menu link*/}
													<a className="menu-link" href="../../demo6/dist/apps/customers/getting-started.html">
														<span className="menu-bullet">
															<span className="bullet bullet-dot"></span>
														</span>
														<span className="menu-title">Getting Started</span>
												...
												<div className="menu-item">
													{/*begin:Menu link*/}
													<a className="menu-link" href="../../demo6/dist/apps/customers/list.html">
														<span className="menu-bullet">
															<span className="bullet bullet-dot"></span>
														</span>
														<span className="menu-title">Customer Listing</span>
												...
												<div className="menu-item">
													{/*begin:Menu link*/}
													<a className="menu-link" href="../../demo6/dist/apps/customers/view.html">
														<span className="menu-bullet">
															<span className="bullet bullet-dot"></span>
														</span>
														<span className="menu-title">Customer Details</span>
										...
										<div data-kt-menu-trigger="click" className="menu-item menu-accordion">
											...
											<div className="menu-sub menu-sub-accordion">
												...
												<div className="menu-item">
													{/*begin:Menu link*/}
													<a className="menu-link" href="../../demo6/dist/apps/subscriptions/getting-started.html">
														<span className="menu-bullet">
															<span className="bullet bullet-dot"></span>
														</span>
														<span className="menu-title">Getting Started</span>
												...
												<div className="menu-item">
													{/*begin:Menu link*/}
													<a className="menu-link" href="../../demo6/dist/apps/subscriptions/list.html">
														<span className="menu-bullet">
															<span className="bullet bullet-dot"></span>
														</span>
												...
												<div className="menu-item">
													{/*begin:Menu link*/}
													<a className="menu-link" href="../../demo6/dist/apps/subscriptions/add.html">
														<span className="menu-bullet">
															<span className="bullet bullet-dot"></span>
														</span>
												...
												<div className="menu-item">
													{/*begin:Menu link*/}
													<a className="menu-link" href="../../demo6/dist/apps/subscriptions/view.html">
														<span className="menu-bullet">
															<span className="bullet bullet-dot"></span>
														</span>
											...
											<div className="menu-sub menu-sub-accordion">
												...
												<div data-kt-menu-trigger="click" className="menu-item menu-accordion">
													...
													<div className="menu-sub menu-sub-accordion menu-active-bg">
														...
														<div className="menu-item">
															{/*begin:Menu link*/}
															<a className="menu-link" href="../../demo6/dist/apps/invoices/view/invoice-1.html">
																<span className="menu-bullet">
																	<span className="bullet bullet-dot"></span>
																</span>
														...
														<div className="menu-item">
															{/*begin:Menu link*/}
															<a className="menu-link" href="../../demo6/dist/apps/invoices/view/invoice-2.html">
																<span className="menu-bullet">
																	<span className="bullet bullet-dot"></span>
																</span>
														...
														<div className="menu-item">
															{/*begin:Menu link*/}
															<a className="menu-link" href="../../demo6/dist/apps/invoices/view/invoice-3.html">
																<span className="menu-bullet">
																	<span className="bullet bullet-dot"></span>
																</span>
												...
												<div className="menu-item">
													{/*begin:Menu link*/}
													<a className="menu-link" href="../../demo6/dist/apps/invoices/create.html">
														<span className="menu-bullet">
															<span className="bullet bullet-dot"></span>
														</span>
										...
										<div data-kt-menu-trigger="click" className="menu-item menu-accordion">
											...
											<div className="menu-sub menu-sub-accordion">
												...
												<div className="menu-item">
													{/*begin:Menu link*/}
													<a className="menu-link" href="../../demo6/dist/apps/file-manager/folders.html">
														<span className="menu-bullet">
															<span className="bullet bullet-dot"></span>
														</span>
												...
												<div className="menu-item">
													{/*begin:Menu link*/}
													<a className="menu-link" href="../../demo6/dist/apps/file-manager/files.html">
														<span className="menu-bullet">
															<span className="bullet bullet-dot"></span>
														</span>
														<span className="menu-title">Files</span>
												...
												<div className="menu-item">
													{/*begin:Menu link*/}
													<a className="menu-link" href="../../demo6/dist/apps/file-manager/blank.html">
														<span className="menu-bullet">
															<span className="bullet bullet-dot"></span>
														</span>
												...
												<div className="menu-item">
													{/*begin:Menu link*/}
													<a className="menu-link" href="../../demo6/dist/apps/file-manager/settings.html">
														<span className="menu-bullet">
															<span className="bullet bullet-dot"></span>
														</span>
														<span className="menu-title">Settings</span>
										...
										<div data-kt-menu-trigger="click" className="menu-item menu-accordion">
											...
											<div className="menu-sub menu-sub-accordion">
												...
												<div className="menu-item">
													{/*begin:Menu link*/}
													<a className="menu-link" href="../../demo6/dist/apps/inbox/listing.html">
														<span className="menu-bullet">
															<span className="bullet bullet-dot"></span>
														</span>
												...
												<div className="menu-item">
													{/*begin:Menu link*/}
													<a className="menu-link" href="../../demo6/dist/apps/inbox/compose.html">
														<span className="menu-bullet">
															<span className="bullet bullet-dot"></span>
														</span>
												...
												<div className="menu-item">
													{/*begin:Menu link*/}
													<a className="menu-link" href="../../demo6/dist/apps/inbox/reply.html">
														<span className="menu-bullet">
															<span className="bullet bullet-dot"></span>
														</span>
										...
										<div data-kt-menu-trigger="click" className="menu-item menu-accordion">
											...
											<div className="menu-sub menu-sub-accordion">
												...
												<div className="menu-item">
													{/*begin:Menu link*/}
													<a className="menu-link" href="../../demo6/dist/apps/chat/private.html">
														<span className="menu-bullet">
															<span className="bullet bullet-dot"></span>
														</span>
												...
												<div className="menu-item">
													{/*begin:Menu link*/}
													<a className="menu-link" href="../../demo6/dist/apps/chat/group.html">
														<span className="menu-bullet">
															<span className="bullet bullet-dot"></span>
														</span>
												...
												<div className="menu-item">
													{/*begin:Menu link*/}
													<a className="menu-link" href="../../demo6/dist/apps/chat/drawer.html">
														<span className="menu-bullet">
															<span className="bullet bullet-dot"></span>
														</span>
										...
										<div className="menu-item">
											{/*begin:Menu link*/}
											<a className="menu-link" href="../../demo6/dist/apps/calendar.html">
												<span className="menu-icon">
								...
								<div data-kt-menu-trigger="{default: 'click', lg: 'hover'}" data-kt-menu-placement="right-start" className="menu-item py-2">
									...
									{/*end:Menu link*/}
									{/*begin:Menu sub*/}
									<div className="menu-sub menu-sub-dropdown px-2 py-4 w-200px w-lg-225px">
										{/*begin:Menu item*/}
										<div className="menu-item">
											{/*begin:Menu content*/}
											<div className="menu-content">
										...
										<div className="menu-item">
											{/*begin:Menu link*/}
											<a className="menu-link" href="https://preview.keenthemes.com/html/metronic/docs/base/utilities" target="blank" title="Check out over 200 in-house components" data-bs-toggle="tooltip" data-bs-trigger="hover" data-bs-dismiss="click" data-bs-placement="right">
												<span className="menu-bullet">
													<span className="bullet bullet-dot"></span>
												</span>
										...
										<div className="menu-item">
											{/*begin:Menu link*/}
											<a className="menu-link" href="https://preview.keenthemes.com/html/metronic/docs" target="blank" title="Check out the complete documentation" data-bs-toggle="tooltip" data-bs-trigger="hover" data-bs-dismiss="click" data-bs-placement="right">
												<span className="menu-bullet">
													<span className="bullet bullet-dot"></span>
												</span>
										...
										<div className="menu-item">
											{/*begin:Menu link*/}
											<a className="menu-link" href="https://preview.keenthemes.com/metronic8/layout-builder.html" title="Build your layout and export HTML for server side integration" data-bs-toggle="tooltip" data-bs-trigger="hover" data-bs-dismiss="click" data-bs-placement="right">
												<span className="menu-bullet">
													<span className="bullet bullet-dot"></span>
												</span>
										...
										<div className="menu-item">
											{/*begin:Menu link*/}
											<a className="menu-link" href="https://preview.keenthemes.com/html/metronic/docs/getting-started/changelog" target="blank">
												<span className="menu-bullet">
													<span className="bullet bullet-dot"></span>
												</span>
												<span className="menu-title">Changelog v8.1.4</span>
											</a>
											{/*end:Menu link*/}
										</div>
										{/*end:Menu item*/}
					...
					<div className="aside-footer flex-column-auto" id="kt_aside_footer">
						...
						<div className="d-flex justify-content-center">
							<button type="button" className="btn btm-sm btn-icon btn-custom btn-active-color-primary" data-kt-menu-trigger="click" data-kt-menu-overflow="true" data-kt-menu-placement="top-start" data-bs-toggle="tooltip" data-bs-placement="right" data-bs-dismiss="click" title="Quick actions">
				...
				<div className="wrapper d-flex flex-column flex-row-fluid" id="kt_wrapper">
					...
					<div id="kt_header" className="header align-items-stretch">
						...
						<div className="container-fluid d-flex align-items-stretch justify-content-between">
							...
							<div className="d-flex align-items-center flex-grow-1 flex-lg-grow-0">
								<a href="../../demo6/dist/index.html" className="d-lg-none">
									<img alt="Logo" src="assets/media/logos/demo6.svg" className="h-30px" />
								</a>
							</div>
							{/*end::Mobile logo*/}
							{/*begin::Wrapper*/}
							<div className="d-flex align-items-stretch justify-content-between flex-lg-grow-1">
								...
								<div className="d-flex align-items-stretch" id="kt_header_nav">
									...
									<div className="header-menu align-items-stretch" data-kt-drawer="true" data-kt-drawer-name="header-menu" data-kt-drawer-activate="{default: true, lg: false}" data-kt-drawer-overlay="true" data-kt-drawer-width="{default:'200px', '300px': '250px'}" data-kt-drawer-direction="end" data-kt-drawer-toggle="#kt_header_menu_mobile_toggle" data-kt-swapper="true" data-kt-swapper-mode="prepend" data-kt-swapper-parent="{default: '#kt_body', lg: '#kt_header_nav'}">
										{/*begin::Menu*/}
										<div className="menu menu-rounded menu-column menu-lg-row menu-active-bg menu-state-primary menu-title-gray-700 menu-arrow-gray-400 fw-semibold my-5 my-lg-0 px-2 px-lg-0 align-items-stretch" id="#kt_header_menu" data-kt-menu="true">
											{/*begin:Menu item*/}
														...
														<div className="row">
															...
															<div className="col-lg-8 mb-3 mb-lg-0 py-3 px-3 py-lg-6 px-lg-6">
																...
																<div className="row">
																	...
																	<div className="col-lg-6 mb-3">
																		...
																		<div className="menu-item p-0 m-0">
																			{/*begin:Menu link*/}
																			<a href="../../demo6/dist/index.html" className="menu-link">
																	...
																	<div className="col-lg-6 mb-3">
																		...
																		<div className="menu-item p-0 m-0">
																			{/*begin:Menu link*/}
																			<a href="../../demo6/dist/dashboards/ecommerce.html" className="menu-link">
																				<span className="menu-custom-icon d-flex flex-center flex-shrink-0 rounded w-40px h-40px me-3">
																	...
																	<div className="col-lg-6 mb-3">
																		...
																		<div className="menu-item p-0 m-0">
																			{/*begin:Menu link*/}
																			<a href="../../demo6/dist/dashboards/projects.html" className="menu-link">
																				<span className="menu-custom-icon d-flex flex-center flex-shrink-0 rounded w-40px h-40px me-3">
																	...
																	<div className="col-lg-6 mb-3">
																		...
																		<div className="menu-item p-0 m-0">
																			{/*begin:Menu link*/}
																			<a href="../../demo6/dist/dashboards/online-courses.html" className="menu-link">
																				<span className="menu-custom-icon d-flex flex-center flex-shrink-0 rounded w-40px h-40px me-3">
																	...
																	<div className="col-lg-6 mb-3">
																		...
																		<div className="menu-item p-0 m-0">
																			{/*begin:Menu link*/}
																			<a href="../../demo6/dist/dashboards/marketing.html" className="menu-link">
																				<span className="menu-custom-icon d-flex flex-center flex-shrink-0 rounded w-40px h-40px me-3">
																	...
																	<div className="col-lg-6 mb-3">
																		...
																		<div className="menu-item p-0 m-0">
																			{/*begin:Menu link*/}
																			<a href="../../demo6/dist/dashboards/bidding.html" className="menu-link">
																				<span className="menu-custom-icon d-flex flex-center flex-shrink-0 rounded w-40px h-40px me-3">
																	...
																	<div className="col-lg-6 mb-3">
																		...
																		<div className="menu-item p-0 m-0">
																			{/*begin:Menu link*/}
																			<a href="../../demo6/dist/dashboards/pos.html" className="menu-link">
																				<span className="menu-custom-icon d-flex flex-center flex-shrink-0 rounded w-40px h-40px me-3">
																	...
																	<div className="col-lg-6 mb-3">
																		...
																		<div className="menu-item p-0 m-0">
																			{/*begin:Menu link*/}
																			<a href="../../demo6/dist/dashboards/call-center.html" className="menu-link">
																				<span className="menu-custom-icon d-flex flex-center flex-shrink-0 rounded w-40px h-40px me-3">
																...
																<div className="d-flex flex-stack flex-wrap flex-lg-nowrap gap-2 mx-5">
																	...
																	<a href="../../demo6/dist/landing.html" className="btn btn-sm btn-primary fw-bold">Explore</a>
																</div>
																{/*end:Landing*/}
															</div>
															{/*end:Col*/}
															...
															<div className="menu-more bg-light col-lg-4 py-3 px-3 py-lg-6 px-lg-6 rounded-end">
																...
																<div className="menu-item p-0 m-0">
																	{/*begin:Menu link*/}
																	<a href="../../demo6/dist/dashboards/logistics.html" className="menu-link py-2">
																		<span className="menu-title">Logistics</span>
																	</a>
																	{/*end:Menu link*/}
																</div>
																...
																<div className="menu-item p-0 m-0">
																	{/*begin:Menu link*/}
																	<a href="../../demo6/dist/dashboards/website-analytics.html" className="menu-link py-2">
																		<span className="menu-title">Website Analytics</span>
																	</a>
																	{/*end:Menu link*/}
																</div>
																...
																<div className="menu-item p-0 m-0">
																	{/*begin:Menu link*/}
																	<a href="../../demo6/dist/dashboards/finance-performance.html" className="menu-link py-2">
																		<span className="menu-title">Finance Performance</span>
																	</a>
																	{/*end:Menu link*/}
																</div>
																...
																<div className="menu-item p-0 m-0">
																	{/*begin:Menu link*/}
																	<a href="../../demo6/dist/dashboards/store-analytics.html" className="menu-link py-2">
																		<span className="menu-title">Store Analytics</span>
																	</a>
																	{/*end:Menu link*/}
																</div>
																...
																<div className="menu-item p-0 m-0">
																	{/*begin:Menu link*/}
																	<a href="../../demo6/dist/dashboards/social.html" className="menu-link py-2">
																		<span className="menu-title">Social</span>
																	</a>
																	{/*end:Menu link*/}
																</div>
																...
																<div className="menu-item p-0 m-0">
																	{/*begin:Menu link*/}
																	<a href="../../demo6/dist/dashboards/delivery.html" className="menu-link py-2">
																		<span className="menu-title">Delivery</span>
																	</a>
																	{/*end:Menu link*/}
																</div>
																...
																<div className="menu-item p-0 m-0">
																	{/*begin:Menu link*/}
																	<a href="../../demo6/dist/dashboards/crypto.html" className="menu-link py-2">
																		<span className="menu-title">Crypto</span>
																	</a>
																	{/*end:Menu link*/}
																</div>
																...
																<div className="menu-item p-0 m-0">
																	{/*begin:Menu link*/}
																	<a href="../../demo6/dist/dashboards/school.html" className="menu-link py-2">
																		<span className="menu-title">School</span>
																	</a>
																	{/*end:Menu link*/}
																</div>
																...
																<div className="menu-item p-0 m-0">
																	{/*begin:Menu link*/}
																	<a href="../../demo6/dist/dashboards/podcast.html" className="menu-link py-2">
																		<span className="menu-title">Podcast</span>
																	</a>
																	{/*end:Menu link*/}
																</div>
																	...
																	<div className="col-lg-8">
																		...
																		<div className="row">
																			...
																			<div className="col-lg-3 mb-6 mb-lg-0">
																				...
																				<div className="menu-item p-0 m-0">
																					{/*begin:Menu link*/}
																					<a href="../../demo6/dist/pages/user-profile/overview.html" className="menu-link">
																						<span className="menu-title">Overview</span>
																					</a>
																					{/*end:Menu link*/}
																				</div>
																				...
																				<div className="menu-item p-0 m-0">
																					{/*begin:Menu link*/}
																					<a href="../../demo6/dist/pages/user-profile/projects.html" className="menu-link">
																						<span className="menu-title">Projects</span>
																					</a>
																					{/*end:Menu link*/}
																				</div>
																				...
																				<div className="menu-item p-0 m-0">
																					{/*begin:Menu link*/}
																					<a href="../../demo6/dist/pages/user-profile/campaigns.html" className="menu-link">
																						<span className="menu-title">Campaigns</span>
																					</a>
																					{/*end:Menu link*/}
																				</div>
																				...
																				<div className="menu-item p-0 m-0">
																					{/*begin:Menu link*/}
																					<a href="../../demo6/dist/pages/user-profile/documents.html" className="menu-link">
																						<span className="menu-title">Documents</span>
																					</a>
																					{/*end:Menu link*/}
																				</div>
																				...
																				<div className="menu-item p-0 m-0">
																					{/*begin:Menu link*/}
																					<a href="../../demo6/dist/pages/user-profile/followers.html" className="menu-link">
																						<span className="menu-title">Followers</span>
																					</a>
																					{/*end:Menu link*/}
																				</div>
																				...
																				<div className="menu-item p-0 m-0">
																					{/*begin:Menu link*/}
																					<a href="../../demo6/dist/pages/user-profile/activity.html" className="menu-link">
																						<span className="menu-title">Activity</span>
																					</a>
																					{/*end:Menu link*/}
																				</div>
																			...
																			<div className="col-lg-3 mb-6 mb-lg-0">
																				...
																				<div className="mb-6">
																					...
																					<div className="menu-item p-0 m-0">
																						{/*begin:Menu link*/}
																						<a href="../../demo6/dist/pages/about.html" className="menu-link">
																							<span className="menu-title">About</span>
																						</a>
																						{/*end:Menu link*/}
																					</div>
																					...
																					<div className="menu-item p-0 m-0">
																						{/*begin:Menu link*/}
																						<a href="../../demo6/dist/pages/team.html" className="menu-link">
																							<span className="menu-title">Our Team</span>
																						</a>
																						{/*end:Menu link*/}
																					</div>
																					...
																					<div className="menu-item p-0 m-0">
																						{/*begin:Menu link*/}
																						<a href="../../demo6/dist/pages/contact.html" className="menu-link">
																							<span className="menu-title">Contact Us</span>
																						</a>
																						{/*end:Menu link*/}
																					</div>
																					...
																					<div className="menu-item p-0 m-0">
																						{/*begin:Menu link*/}
																						<a href="../../demo6/dist/pages/licenses.html" className="menu-link">
																							<span className="menu-title">Licenses</span>
																						</a>
																						{/*end:Menu link*/}
																					</div>
																					...
																					<div className="menu-item p-0 m-0">
																						{/*begin:Menu link*/}
																						<a href="../../demo6/dist/pages/sitemap.html" className="menu-link">
																							<span className="menu-title">Sitemap</span>
																						</a>
																						{/*end:Menu link*/}
																					</div>
																				...
																				<div className="mb-0">
																					...
																					<div className="menu-item p-0 m-0">
																						{/*begin:Menu link*/}
																						<a href="../../demo6/dist/pages/careers/list.html" className="menu-link">
																							<span className="menu-title">Careers List</span>
																						</a>
																						{/*end:Menu link*/}
																					</div>
																					...
																					<div className="menu-item p-0 m-0">
																						{/*begin:Menu link*/}
																						<a href="../../demo6/dist/pages/careers/apply.html" className="menu-link">
																							<span className="menu-title">Careers Apply</span>
																						</a>
																						{/*end:Menu link*/}
																					</div>
																			...
																			<div className="col-lg-3 mb-6 mb-lg-0">
																				...
																				<div className="mb-6">
																					...
																					<div className="menu-item p-0 m-0">
																						{/*begin:Menu link*/}
																						<a href="../../demo6/dist/pages/faq/classNameic.html" className="menu-link">
																					...
																					<div className="menu-item p-0 m-0">
																						{/*begin:Menu link*/}
																						<a href="../../demo6/dist/pages/faq/extended.html" className="menu-link">
																				...
																				<div className="mb-6">
																					...
																					<div className="menu-item p-0 m-0">
																						{/*begin:Menu link*/}
																						<a href="../../demo6/dist/pages/blog/home.html" className="menu-link">
																							<span className="menu-title">Blog Home</span>
																						</a>
																						{/*end:Menu link*/}
																					</div>
																					...
																					<div className="menu-item p-0 m-0">
																						{/*begin:Menu link*/}
																						<a href="../../demo6/dist/pages/blog/post.html" className="menu-link">
																							<span className="menu-title">Blog Post</span>
																						</a>
																						{/*end:Menu link*/}
																					</div>
																				...
																				<div className="mb-0">
																					...
																					<div className="menu-item p-0 m-0">
																						{/*begin:Menu link*/}
																						<a href="../../demo6/dist/pages/pricing/column.html" className="menu-link">
																					...
																					<div className="menu-item p-0 m-0">
																						{/*begin:Menu link*/}
																						<a href="../../demo6/dist/pages/pricing/table.html" className="menu-link">
																			...
																			<div className="col-lg-3 mb-6 mb-lg-0">
																				...
																				<div className="mb-0">
																					...
																					<div className="menu-item p-0 m-0">
																						{/*begin:Menu link*/}
																						<a href="../../demo6/dist/pages/social/feeds.html" className="menu-link">
																							<span className="menu-title">Feeds</span>
																						</a>
																						{/*end:Menu link*/}
																					</div>
																					...
																					<div className="menu-item p-0 m-0">
																						{/*begin:Menu link*/}
																						<a href="../../demo6/dist/pages/social/activity.html" className="menu-link">
																							<span className="menu-title">Activty</span>
																						</a>
																						{/*end:Menu link*/}
																					</div>
																					...
																					<div className="menu-item p-0 m-0">
																						{/*begin:Menu link*/}
																						<a href="../../demo6/dist/pages/social/followers.html" className="menu-link">
																							<span className="menu-title">Followers</span>
																						</a>
																						{/*end:Menu link*/}
																					</div>
																					...
																					<div className="menu-item p-0 m-0">
																						{/*begin:Menu link*/}
																						<a href="../../demo6/dist/pages/social/settings.html" className="menu-link">
																							<span className="menu-title">Settings</span>
																						</a>
																						{/*end:Menu link*/}
																					</div>
																	...
																	<div className="col-lg-5 mb-6 mb-lg-0">
																		...
																		<div className="row">
																			...
																			<div className="col-lg-6">
																				...
																				<div className="menu-item p-0 m-0">
																					{/*begin:Menu link*/}
																					<a href="../../demo6/dist/account/overview.html" className="menu-link">
																						<span className="menu-title">Overview</span>
																					</a>
																					{/*end:Menu link*/}
																				</div>
																				...
																				<div className="menu-item p-0 m-0">
																					{/*begin:Menu link*/}
																					<a href="../../demo6/dist/account/settings.html" className="menu-link">
																						<span className="menu-title">Settings</span>
																					</a>
																					{/*end:Menu link*/}
																				</div>
																				...
																				<div className="menu-item p-0 m-0">
																					{/*begin:Menu link*/}
																					<a href="../../demo6/dist/account/security.html" className="menu-link">
																						<span className="menu-title">Security</span>
																					</a>
																					{/*end:Menu link*/}
																				</div>
																				...
																				<div className="menu-item p-0 m-0">
																					{/*begin:Menu link*/}
																					<a href="../../demo6/dist/account/activity.html" className="menu-link">
																						<span className="menu-title">Activity</span>
																					</a>
																					{/*end:Menu link*/}
																				</div>
																				...
																				<div className="menu-item p-0 m-0">
																					{/*begin:Menu link*/}
																					<a href="../../demo6/dist/account/billing.html" className="menu-link">
																						<span className="menu-title">Billing</span>
																					</a>
																					{/*end:Menu link*/}
																				</div>
																			...
																			<div className="col-lg-6">
																				...
																				<div className="menu-item p-0 m-0">
																					{/*begin:Menu link*/}
																					<a href="../../demo6/dist/account/statements.html" className="menu-link">
																						<span className="menu-title">Statements</span>
																					</a>
																					{/*end:Menu link*/}
																				</div>
																				...
																				<div className="menu-item p-0 m-0">
																					{/*begin:Menu link*/}
																					<a href="../../demo6/dist/account/referrals.html" className="menu-link">
																						<span className="menu-title">Referrals</span>
																					</a>
																					{/*end:Menu link*/}
																				</div>
																				...
																				<div className="menu-item p-0 m-0">
																					{/*begin:Menu link*/}
																					<a href="../../demo6/dist/account/api-keys.html" className="menu-link">
																						<span className="menu-title">API Keys</span>
																					</a>
																					{/*end:Menu link*/}
																				</div>
																				...
																				<div className="menu-item p-0 m-0">
																					{/*begin:Menu link*/}
																					<a href="../../demo6/dist/account/logs.html" className="menu-link">
																						<span className="menu-title">Logs</span>
																					</a>
																					{/*end:Menu link*/}
																				</div>
																...
																<div className="row">
																	...
																	<div className="col-lg-3 mb-6 mb-lg-0">
																		...
																		<div className="mb-6">
																			...
																			<div className="menu-item p-0 m-0">
																				{/*begin:Menu link*/}
																				<a href="../../demo6/dist/authentication/layouts/corporate/sign-in.html" className="menu-link">
																					<span className="menu-title">Sign-in</span>
																				</a>
																				{/*end:Menu link*/}
																			</div>
																			...
																			<div className="menu-item p-0 m-0">
																				{/*begin:Menu link*/}
																				<a href="../../demo6/dist/authentication/layouts/corporate/sign-up.html" className="menu-link">
																					<span className="menu-title">Sign-up</span>
																				</a>
																				{/*end:Menu link*/}
																			</div>
																			...
																			<div className="menu-item p-0 m-0">
																				{/*begin:Menu link*/}
																				<a href="../../demo6/dist/authentication/layouts/corporate/two-steps.html" className="menu-link">
																					<span className="menu-title">Two-steps</span>
																				</a>
																				{/*end:Menu link*/}
																			</div>
																			...
																			<div className="menu-item p-0 m-0">
																				{/*begin:Menu link*/}
																				<a href="../../demo6/dist/authentication/layouts/corporate/reset-password.html" className="menu-link">
																					<span className="menu-title">Reset Password</span>
																				</a>
																				{/*end:Menu link*/}
																			</div>
																			...
																			<div className="menu-item p-0 m-0">
																				{/*begin:Menu link*/}
																				<a href="../../demo6/dist/authentication/layouts/corporate/new-password.html" className="menu-link">
																					<span className="menu-title">New Password</span>
																				</a>
																				{/*end:Menu link*/}
																			</div>
																		...
																		<div className="mb-0">
																			...
																			<div className="menu-item p-0 m-0">
																				{/*begin:Menu link*/}
																				<a href="../../demo6/dist/authentication/layouts/overlay/sign-in.html" className="menu-link">
																					<span className="menu-title">Sign-in</span>
																				</a>
																				{/*end:Menu link*/}
																			</div>
																			...
																			<div className="menu-item p-0 m-0">
																				{/*begin:Menu link*/}
																				<a href="../../demo6/dist/authentication/layouts/overlay/sign-up.html" className="menu-link">
																					<span className="menu-title">Sign-up</span>
																				</a>
																				{/*end:Menu link*/}
																			</div>
																			...
																			<div className="menu-item p-0 m-0">
																				{/*begin:Menu link*/}
																				<a href="../../demo6/dist/authentication/layouts/overlay/two-steps.html" className="menu-link">
																					<span className="menu-title">Two-steps</span>
																				</a>
																				{/*end:Menu link*/}
																			</div>
																			...
																			<div className="menu-item p-0 m-0">
																				{/*begin:Menu link*/}
																				<a href="../../demo6/dist/authentication/layouts/overlay/reset-password.html" className="menu-link">
																					<span className="menu-title">Reset Password</span>
																				</a>
																				{/*end:Menu link*/}
																			</div>
																			...
																			<div className="menu-item p-0 m-0">
																				{/*begin:Menu link*/}
																				<a href="../../demo6/dist/authentication/layouts/overlay/new-password.html" className="menu-link">
																					<span className="menu-title">New Password</span>
																				</a>
																				{/*end:Menu link*/}
																			</div>
																	...
																	<div className="col-lg-3 mb-6 mb-lg-0">
																		...
																		<div className="mb-6">
																			...
																			<div className="menu-item p-0 m-0">
																				{/*begin:Menu link*/}
																				<a href="../../demo6/dist/authentication/layouts/creative/sign-in.html" className="menu-link">
																					<span className="menu-title">Sign-in</span>
																				</a>
																				{/*end:Menu link*/}
																			</div>
																			...
																			<div className="menu-item p-0 m-0">
																				{/*begin:Menu link*/}
																				<a href="../../demo6/dist/authentication/layouts/creative/sign-up.html" className="menu-link">
																					<span className="menu-title">Sign-up</span>
																				</a>
																				{/*end:Menu link*/}
																			</div>
																			...
																			<div className="menu-item p-0 m-0">
																				{/*begin:Menu link*/}
																				<a href="../../demo6/dist/authentication/layouts/creative/two-steps.html" className="menu-link">
																					<span className="menu-title">Two-steps</span>
																				</a>
																				{/*end:Menu link*/}
																			</div>
																			...
																			<div className="menu-item p-0 m-0">
																				{/*begin:Menu link*/}
																				<a href="../../demo6/dist/authentication/layouts/creative/reset-password.html" className="menu-link">
																					<span className="menu-title">Reset Password</span>
																				</a>
																				{/*end:Menu link*/}
																			</div>
																			...
																			<div className="menu-item p-0 m-0">
																				{/*begin:Menu link*/}
																				<a href="../../demo6/dist/authentication/layouts/creative/new-password.html" className="menu-link">
																					<span className="menu-title">New Password</span>
																				</a>
																				{/*end:Menu link*/}
																			</div>
																		...
																		<div className="mb-6">
																			...
																			<div className="menu-item p-0 m-0">
																				{/*begin:Menu link*/}
																				<a href="../../demo6/dist/authentication/layouts/fancy/sign-in.html" className="menu-link">
																					<span className="menu-title">Sign-in</span>
																				</a>
																				{/*end:Menu link*/}
																			</div>
																			...
																			<div className="menu-item p-0 m-0">
																				{/*begin:Menu link*/}
																				<a href="../../demo6/dist/authentication/layouts/fancy/sign-up.html" className="menu-link">
																					<span className="menu-title">Sign-up</span>
																				</a>
																				{/*end:Menu link*/}
																			</div>
																			...
																			<div className="menu-item p-0 m-0">
																				{/*begin:Menu link*/}
																				<a href="../../demo6/dist/authentication/layouts/fancy/two-steps.html" className="menu-link">
																					<span className="menu-title">Two-steps</span>
																				</a>
																				{/*end:Menu link*/}
																			</div>
																			...
																			<div className="menu-item p-0 m-0">
																				{/*begin:Menu link*/}
																				<a href="../../demo6/dist/authentication/layouts/fancy/reset-password.html" className="menu-link">
																					<span className="menu-title">Reset Password</span>
																				</a>
																				{/*end:Menu link*/}
																			</div>
																			...
																			<div className="menu-item p-0 m-0">
																				{/*begin:Menu link*/}
																				<a href="../../demo6/dist/authentication/layouts/fancy/new-password.html" className="menu-link">
																					<span className="menu-title">New Password</span>
																				</a>
																				{/*end:Menu link*/}
																			</div>
																	...
																	<div className="col-lg-3 mb-6 mb-lg-0">
																		...
																		<div className="mb-0">
																			...
																			<div className="menu-item p-0 m-0">
																				{/*begin:Menu link*/}
																				<a href="../../demo6/dist/authentication/extended/multi-steps-sign-up.html" className="menu-link">
																					<span className="menu-title">Multi-steps Sign-up</span>
																				</a>
																				{/*end:Menu link*/}
																			</div>
																			...
																			<div className="menu-item p-0 m-0">
																				{/*begin:Menu link*/}
																				<a href="../../demo6/dist/authentication/extended/two-factor-auth.html" className="menu-link">
																					<span className="menu-title">Two Factor Auth</span>
																				</a>
																				{/*end:Menu link*/}
																			</div>
																			...
																			<div className="menu-item p-0 m-0">
																				{/*begin:Menu link*/}
																				<a href="../../demo6/dist/authentication/general/welcome.html" className="menu-link">
																					<span className="menu-title">Welcome Message</span>
																				</a>
																				{/*end:Menu link*/}
																			</div>
																			...
																			<div className="menu-item p-0 m-0">
																				{/*begin:Menu link*/}
																				<a href="../../demo6/dist/authentication/general/verify-email.html" className="menu-link">
																					<span className="menu-title">Verify Email</span>
																				</a>
																				{/*end:Menu link*/}
																			</div>
																			...
																			<div className="menu-item p-0 m-0">
																				{/*begin:Menu link*/}
																				<a href="../../demo6/dist/authentication/extended/coming-soon.html" className="menu-link">
																					<span className="menu-title">Coming Soon</span>
																				</a>
																				{/*end:Menu link*/}
																			</div>
																			...
																			<div className="menu-item p-0 m-0">
																				{/*begin:Menu link*/}
																				<a href="../../demo6/dist/authentication/general/password-confirmation.html" className="menu-link">
																					<span className="menu-title">Password Confirmation</span>
																				</a>
																				{/*end:Menu link*/}
																			</div>
																			...
																			<div className="menu-item p-0 m-0">
																				{/*begin:Menu link*/}
																				<a href="../../demo6/dist/authentication/general/account-deactivated.html" className="menu-link">
																					<span className="menu-title">Account Deactivation</span>
																				</a>
																				{/*end:Menu link*/}
																			</div>
																			...
																			<div className="menu-item p-0 m-0">
																				{/*begin:Menu link*/}
																				<a href="../../demo6/dist/authentication/general/error-404.html" className="menu-link">
																					<span className="menu-title">Error 404</span>
																				</a>
																				{/*end:Menu link*/}
																			</div>
																			...
																			<div className="menu-item p-0 m-0">
																				{/*begin:Menu link*/}
																				<a href="../../demo6/dist/authentication/general/error-500.html" className="menu-link">
																					<span className="menu-title">Error 500</span>
																				</a>
																				{/*end:Menu link*/}
																			</div>
																	...
																	<div className="col-lg-3 mb-6 mb-lg-0">
																		...
																		<div className="mb-0">
																			...
																			<div className="menu-item p-0 m-0">
																				{/*begin:Menu link*/}
																				<a href="../../demo6/dist/authentication/email/welcome-message.html" className="menu-link">
																					<span className="menu-title">Welcome Message</span>
																				</a>
																				{/*end:Menu link*/}
																			</div>
																			...
																			<div className="menu-item p-0 m-0">
																				{/*begin:Menu link*/}
																				<a href="../../demo6/dist/authentication/email/reset-password.html" className="menu-link">
																					<span className="menu-title">Reset Password</span>
																				</a>
																				{/*end:Menu link*/}
																			</div>
																			...
																			<div className="menu-item p-0 m-0">
																				{/*begin:Menu link*/}
																				<a href="../../demo6/dist/authentication/email/subscription-confirmed.html" className="menu-link">
																					<span className="menu-title">Subscription Confirmed</span>
																				</a>
																				{/*end:Menu link*/}
																			</div>
																			...
																			<div className="menu-item p-0 m-0">
																				{/*begin:Menu link*/}
																				<a href="../../demo6/dist/authentication/email/card-declined.html" className="menu-link">
																					<span className="menu-title">Credit Card Declined</span>
																				</a>
																				{/*end:Menu link*/}
																			</div>
																			...
																			<div className="menu-item p-0 m-0">
																				{/*begin:Menu link*/}
																				<a href="../../demo6/dist/authentication/email/promo-1.html" className="menu-link">
																					<span className="menu-title">Promo 1</span>
																				</a>
																				{/*end:Menu link*/}
																			</div>
																			...
																			<div className="menu-item p-0 m-0">
																				{/*begin:Menu link*/}
																				<a href="../../demo6/dist/authentication/email/promo-2.html" className="menu-link">
																					<span className="menu-title">Promo 2</span>
																				</a>
																				{/*end:Menu link*/}
																			</div>
																			...
																			<div className="menu-item p-0 m-0">
																				{/*begin:Menu link*/}
																				<a href="../../demo6/dist/authentication/email/promo-3.html" className="menu-link">
																					<span className="menu-title">Promo 3</span>
																				</a>
																				{/*end:Menu link*/}
																			</div>
																		...
																		<div className="row">
																			...
																			<div className="col-lg-4 mb-6 mb-lg-0">
																				...
																				<div className="mb-0">
																					...
																					<div className="menu-item p-0 m-0">
																						{/*begin:Menu link*/}
																						<a href="../../demo6/dist/utilities/modals/general/invite-friends.html" className="menu-link">
																							<span className="menu-title">Invite Friends</span>
																						</a>
																						{/*end:Menu link*/}
																					</div>
																					...
																					<div className="menu-item p-0 m-0">
																						{/*begin:Menu link*/}
																						<a href="../../demo6/dist/utilities/modals/general/view-users.html" className="menu-link">
																							<span className="menu-title">View Users</span>
																						</a>
																						{/*end:Menu link*/}
																					</div>
																					...
																					<div className="menu-item p-0 m-0">
																						{/*begin:Menu link*/}
																						<a href="../../demo6/dist/utilities/modals/general/select-users.html" className="menu-link">
																							<span className="menu-title">Select Users</span>
																						</a>
																						{/*end:Menu link*/}
																					</div>
																					...
																					<div className="menu-item p-0 m-0">
																						{/*begin:Menu link*/}
																						<a href="../../demo6/dist/utilities/modals/general/upgrade-plan.html" className="menu-link">
																							<span className="menu-title">Upgrade Plan</span>
																						</a>
																						{/*end:Menu link*/}
																					</div>
																					...
																					<div className="menu-item p-0 m-0">
																						{/*begin:Menu link*/}
																						<a href="../../demo6/dist/utilities/modals/general/share-earn.html" className="menu-link">
																							<span className="menu-title">Share & Earn</span>
																						</a>
																						{/*end:Menu link*/}
																					</div>
																					...
																					<div className="menu-item p-0 m-0">
																						{/*begin:Menu link*/}
																						<a href="../../demo6/dist/utilities/modals/forms/new-target.html" className="menu-link">
																							<span className="menu-title">New Target</span>
																						</a>
																						{/*end:Menu link*/}
																					</div>
																					...
																					<div className="menu-item p-0 m-0">
																						{/*begin:Menu link*/}
																						<a href="../../demo6/dist/utilities/modals/forms/new-card.html" className="menu-link">
																							<span className="menu-title">New Card</span>
																						</a>
																						{/*end:Menu link*/}
																					</div>
																					...
																					<div className="menu-item p-0 m-0">
																						{/*begin:Menu link*/}
																						<a href="../../demo6/dist/utilities/modals/forms/new-address.html" className="menu-link">
																							<span className="menu-title">New Address</span>
																						</a>
																						{/*end:Menu link*/}
																					</div>
																					...
																					<div className="menu-item p-0 m-0">
																						{/*begin:Menu link*/}
																						<a href="../../demo6/dist/utilities/modals/forms/create-api-key.html" className="menu-link">
																							<span className="menu-title">Create API Key</span>
																						</a>
																						{/*end:Menu link*/}
																					</div>
																					...
																					<div className="menu-item p-0 m-0">
																						{/*begin:Menu link*/}
																						<a href="../../demo6/dist/utilities/modals/forms/bidding.html" className="menu-link">
																							<span className="menu-title">Bidding</span>
																						</a>
																						{/*end:Menu link*/}
																					</div>
																			...
																			<div className="col-lg-4 mb-6 mb-lg-0">
																				...
																				<div className="mb-6">
																					...
																					<div className="menu-item p-0 m-0">
																						{/*begin:Menu link*/}
																						<a href="../../demo6/dist/utilities/modals/wizards/create-app.html" className="menu-link">
																							<span className="menu-title">Create App</span>
																						</a>
																						{/*end:Menu link*/}
																					</div>
																					...
																					<div className="menu-item p-0 m-0">
																						{/*begin:Menu link*/}
																						<a href="../../demo6/dist/utilities/modals/wizards/create-campaign.html" className="menu-link">
																							<span className="menu-title">Create Campaign</span>
																						</a>
																						{/*end:Menu link*/}
																					</div>
																					...
																					<div className="menu-item p-0 m-0">
																						{/*begin:Menu link*/}
																						<a href="../../demo6/dist/utilities/modals/wizards/create-account.html" className="menu-link">
																							<span className="menu-title">Create Business Acc</span>
																						</a>
																						{/*end:Menu link*/}
																					</div>
																					...
																					<div className="menu-item p-0 m-0">
																						{/*begin:Menu link*/}
																						<a href="../../demo6/dist/utilities/modals/wizards/create-project.html" className="menu-link">
																							<span className="menu-title">Create Project</span>
																						</a>
																						{/*end:Menu link*/}
																					</div>
																					...
																					<div className="menu-item p-0 m-0">
																						{/*begin:Menu link*/}
																						<a href="../../demo6/dist/utilities/modals/wizards/top-up-wallet.html" className="menu-link">
																							<span className="menu-title">Top Up Wallet</span>
																						</a>
																						{/*end:Menu link*/}
																					</div>
																					...
																					<div className="menu-item p-0 m-0">
																						{/*begin:Menu link*/}
																						<a href="../../demo6/dist/utilities/modals/wizards/offer-a-deal.html" className="menu-link">
																							<span className="menu-title">Offer a Deal</span>
																						</a>
																						{/*end:Menu link*/}
																					</div>
																					...
																					<div className="menu-item p-0 m-0">
																						{/*begin:Menu link*/}
																						<a href="../../demo6/dist/utilities/modals/wizards/two-factor-authentication.html" className="menu-link">
																							<span className="menu-title">Two Factor Auth</span>
																						</a>
																						{/*end:Menu link*/}
																					</div>
																				...
																				<div className="mb-0">
																					...
																					<div className="menu-item p-0 m-0">
																						{/*begin:Menu link*/}
																						<a href="../../demo6/dist/utilities/search/horizontal.html" className="menu-link">
																							<span className="menu-title">Horizontal</span>
																						</a>
																						{/*end:Menu link*/}
																					</div>
																					...
																					<div className="menu-item p-0 m-0">
																						{/*begin:Menu link*/}
																						<a href="../../demo6/dist/utilities/search/vertical.html" className="menu-link">
																							<span className="menu-title">Vertical</span>
																						</a>
																						{/*end:Menu link*/}
																					</div>
																					...
																					<div className="menu-item p-0 m-0">
																						{/*begin:Menu link*/}
																						<a href="../../demo6/dist/utilities/modals/search/users.html" className="menu-link">
																							<span className="menu-title">Users</span>
																						</a>
																						{/*end:Menu link*/}
																					</div>
																					...
																					<div className="menu-item p-0 m-0">
																						{/*begin:Menu link*/}
																						<a href="../../demo6/dist/utilities/modals/search/select-location.html" className="menu-link">
																							<span className="menu-title">Select Location</span>
																						</a>
																						{/*end:Menu link*/}
																					</div>
																			...
																			<div className="col-lg-4 mb-6 mb-lg-0">
																				...
																				<div className="mb-0">
																					...
																					<div className="menu-item p-0 m-0">
																						{/*begin:Menu link*/}
																						<a href="../../demo6/dist/utilities/wizards/horizontal.html" className="menu-link">
																							<span className="menu-title">Horizontal</span>
																						</a>
																						{/*end:Menu link*/}
																					</div>
																					...
																					<div className="menu-item p-0 m-0">
																						{/*begin:Menu link*/}
																						<a href="../../demo6/dist/utilities/wizards/vertical.html" className="menu-link">
																							<span className="menu-title">Vertical</span>
																						</a>
																						{/*end:Menu link*/}
																					</div>
																					...
																					<div className="menu-item p-0 m-0">
																						{/*begin:Menu link*/}
																						<a href="../../demo6/dist/utilities/wizards/two-factor-authentication.html" className="menu-link">
																							<span className="menu-title">Two Factor Auth</span>
																						</a>
																						{/*end:Menu link*/}
																					</div>
																					...
																					<div className="menu-item p-0 m-0">
																						{/*begin:Menu link*/}
																						<a href="../../demo6/dist/utilities/wizards/create-app.html" className="menu-link">
																							<span className="menu-title">Create App</span>
																						</a>
																						{/*end:Menu link*/}
																					</div>
																					...
																					<div className="menu-item p-0 m-0">
																						{/*begin:Menu link*/}
																						<a href="../../demo6/dist/utilities/wizards/create-campaign.html" className="menu-link">
																							<span className="menu-title">Create Campaign</span>
																						</a>
																						{/*end:Menu link*/}
																					</div>
																					...
																					<div className="menu-item p-0 m-0">
																						{/*begin:Menu link*/}
																						<a href="../../demo6/dist/utilities/wizards/create-account.html" className="menu-link">
																							<span className="menu-title">Create Account</span>
																						</a>
																						{/*end:Menu link*/}
																					</div>
																					...
																					<div className="menu-item p-0 m-0">
																						{/*begin:Menu link*/}
																						<a href="../../demo6/dist/utilities/wizards/create-project.html" className="menu-link">
																							<span className="menu-title">Create Project</span>
																						</a>
																						{/*end:Menu link*/}
																					</div>
																					...
																					<div className="menu-item p-0 m-0">
																						{/*begin:Menu link*/}
																						<a href="../../demo6/dist/utilities/wizards/offer-a-deal.html" className="menu-link">
																							<span className="menu-title">Offer a Deal</span>
																						</a>
																						{/*end:Menu link*/}
																					</div>
															...
															<div className="tab-pane w-lg-500px" id="kt_app_header_menu_pages_widgets">
																...
																<div className="row">
																	...
																	<div className="col-lg-4 mb-6 mb-lg-0">
																		...
																		<div className="menu-item p-0 m-0">
																			{/*begin:Menu link*/}
																			<a href="../../demo6/dist/widgets/lists.html" className="menu-link">
																		...
																		<div className="menu-item p-0 m-0">
																			{/*begin:Menu link*/}
																			<a href="../../demo6/dist/widgets/statistics.html" className="menu-link">
																		...
																		<div className="menu-item p-0 m-0">
																			{/*begin:Menu link*/}
																			<a href="../../demo6/dist/widgets/charts.html" className="menu-link">
																		...
																		<div className="menu-item p-0 m-0">
																			{/*begin:Menu link*/}
																			<a href="../../demo6/dist/widgets/mixed.html" className="menu-link">
																		...
																		<div className="menu-item p-0 m-0">
																			{/*begin:Menu link*/}
																			<a href="../../demo6/dist/widgets/tables.html" className="menu-link">
																		...
																		<div className="menu-item p-0 m-0">
																			{/*begin:Menu link*/}
																			<a href="../../demo6/dist/widgets/feeds.html" className="menu-link">
																				<span className="menu-title">Feeds</span>
																			</a>
																			{/*end:Menu link*/}
																		</div>
												...
												<div className="menu-sub menu-sub-lg-down-accordion menu-sub-lg-dropdown px-lg-2 py-lg-4 w-lg-250px">
													...
													<div data-kt-menu-trigger="{default:'click', lg: 'hover'}" data-kt-menu-placement="right-start" className="menu-item menu-lg-down-accordion">
														...
														<div className="menu-sub menu-sub-lg-down-accordion menu-sub-lg-dropdown menu-active-bg px-lg-2 py-lg-4 w-lg-225px">
															...
															<div className="menu-item">
																{/*begin:Menu link*/}
																<a className="menu-link py-3" href="../../demo6/dist/apps/projects/list.html">
																	<span className="menu-bullet">
																		<span className="bullet bullet-dot"></span>
																	</span>
																	<span className="menu-title">My Projects</span>
															...
															<div className="menu-item">
																{/*begin:Menu link*/}
																<a className="menu-link py-3" href="../../demo6/dist/apps/projects/project.html">
																	<span className="menu-bullet">
																		<span className="bullet bullet-dot"></span>
																	</span>
																	<span className="menu-title">View Project</span>
															...
															<div className="menu-item">
																{/*begin:Menu link*/}
																<a className="menu-link py-3" href="../../demo6/dist/apps/projects/targets.html">
																	<span className="menu-bullet">
																		<span className="bullet bullet-dot"></span>
																	</span>
																	<span className="menu-title">Targets</span>
															...
															<div className="menu-item">
																{/*begin:Menu link*/}
																<a className="menu-link py-3" href="../../demo6/dist/apps/projects/budget.html">
																	<span className="menu-bullet">
																		<span className="bullet bullet-dot"></span>
																	</span>
																	<span className="menu-title">Budget</span>
															...
															<div className="menu-item">
																{/*begin:Menu link*/}
																<a className="menu-link py-3" href="../../demo6/dist/apps/projects/users.html">
																	<span className="menu-bullet">
																		<span className="bullet bullet-dot"></span>
																	</span>
																	<span className="menu-title">Users</span>
															...
															<div className="menu-item">
																{/*begin:Menu link*/}
																<a className="menu-link py-3" href="../../demo6/dist/apps/projects/files.html">
																	<span className="menu-bullet">
																		<span className="bullet bullet-dot"></span>
																	</span>
																	<span className="menu-title">Files</span>
															...
															<div className="menu-item">
																{/*begin:Menu link*/}
																<a className="menu-link py-3" href="../../demo6/dist/apps/projects/activity.html">
																	<span className="menu-bullet">
																		<span className="bullet bullet-dot"></span>
																	</span>
																	<span className="menu-title">Activity</span>
															...
															<div className="menu-item">
																{/*begin:Menu link*/}
																<a className="menu-link py-3" href="../../demo6/dist/apps/projects/settings.html">
																	<span className="menu-bullet">
																		<span className="bullet bullet-dot"></span>
																	</span>
																	<span className="menu-title">Settings</span>
														...
														<div className="menu-sub menu-sub-lg-down-accordion menu-sub-lg-dropdown menu-active-bg px-lg-2 py-lg-4 w-lg-225px">
															...
															<div data-kt-menu-trigger="{default:'click', lg: 'hover'}" data-kt-menu-placement="right-start" className="menu-item here show menu-lg-down-accordion">
																...
																<div className="menu-sub menu-sub-lg-down-accordion menu-sub-lg-dropdown menu-active-bg px-lg-2 py-lg-4 w-lg-225px">
																	...
																	<div className="menu-item">
																		{/*begin:Menu link*/}
																		<a className="menu-link py-3" href="../../demo6/dist/apps/ecommerce/catalog/products.html">
																			<span className="menu-bullet">
																				<span className="bullet bullet-dot"></span>
																			</span>
																			<span className="menu-title">Products</span>
																	...
																	<div className="menu-item">
																		{/*begin:Menu link*/}
																		<a className="menu-link py-3" href="../../demo6/dist/apps/ecommerce/catalog/categories.html">
																			<span className="menu-bullet">
																				<span className="bullet bullet-dot"></span>
																			</span>
																			<span className="menu-title">Categories</span>
																	...
																	<div className="menu-item">
																		{/*begin:Menu link*/}
																		<a className="menu-link active py-3" href="../../demo6/dist/apps/ecommerce/catalog/add-product.html">
																			<span className="menu-bullet">
																				<span className="bullet bullet-dot"></span>
																			</span>
																			<span className="menu-title">Add Product</span>
																	...
																	<div className="menu-item">
																		{/*begin:Menu link*/}
																		<a className="menu-link py-3" href="../../demo6/dist/apps/ecommerce/catalog/edit-product.html">
																			<span className="menu-bullet">
																				<span className="bullet bullet-dot"></span>
																			</span>
																			<span className="menu-title">Edit Product</span>
																	...
																	<div className="menu-item">
																		{/*begin:Menu link*/}
																		<a className="menu-link py-3" href="../../demo6/dist/apps/ecommerce/catalog/add-category.html">
																			<span className="menu-bullet">
																				<span className="bullet bullet-dot"></span>
																			</span>
																			<span className="menu-title">Add Category</span>
																	...
																	<div className="menu-item">
																		{/*begin:Menu link*/}
																		<a className="menu-link py-3" href="../../demo6/dist/apps/ecommerce/catalog/edit-category.html">
																			<span className="menu-bullet">
																				<span className="bullet bullet-dot"></span>
																			</span>
																			<span className="menu-title">Edit Category</span>
															...
															<div data-kt-menu-trigger="click" className="menu-item menu-accordion menu-sub-indention">
																...
																<div className="menu-sub menu-sub-accordion">
																	...
																	<div className="menu-item">
																		{/*begin:Menu link*/}
																		<a className="menu-link py-3" href="../../demo6/dist/apps/ecommerce/sales/listing.html">
																			<span className="menu-bullet">
																				<span className="bullet bullet-dot"></span>
																			</span>
																			<span className="menu-title">Orders Listing</span>
																	...
																	<div className="menu-item">
																		{/*begin:Menu link*/}
																		<a className="menu-link py-3" href="../../demo6/dist/apps/ecommerce/sales/details.html">
																			<span className="menu-bullet">
																				<span className="bullet bullet-dot"></span>
																			</span>
																			<span className="menu-title">Order Details</span>
																	...
																	<div className="menu-item">
																		{/*begin:Menu link*/}
																		<a className="menu-link py-3" href="../../demo6/dist/apps/ecommerce/sales/add-order.html">
																			<span className="menu-bullet">
																				<span className="bullet bullet-dot"></span>
																			</span>
																			<span className="menu-title">Add Order</span>
																	...
																	<div className="menu-item">
																		{/*begin:Menu link*/}
																		<a className="menu-link py-3" href="../../demo6/dist/apps/ecommerce/sales/edit-order.html">
																			<span className="menu-bullet">
																				<span className="bullet bullet-dot"></span>
																			</span>
																			<span className="menu-title">Edit Order</span>
															...
															<div data-kt-menu-trigger="click" className="menu-item menu-accordion menu-sub-indention">
																...
																<div className="menu-sub menu-sub-accordion">
																	...
																	<div className="menu-item">
																		{/*begin:Menu link*/}
																		<a className="menu-link py-3" href="../../demo6/dist/apps/ecommerce/customers/listing.html">
																			<span className="menu-bullet">
																				<span className="bullet bullet-dot"></span>
																			</span>
																	...
																	<div className="menu-item">
																		{/*begin:Menu link*/}
																		<a className="menu-link py-3" href="../../demo6/dist/apps/ecommerce/customers/details.html">
																			<span className="menu-bullet">
																				<span className="bullet bullet-dot"></span>
																			</span>
															...
															<div data-kt-menu-trigger="click" className="menu-item menu-accordion menu-sub-indention">
																...
																<div className="menu-sub menu-sub-accordion">
																	...
																	<div className="menu-item">
																		{/*begin:Menu link*/}
																		<a className="menu-link py-3" href="../../demo6/dist/apps/ecommerce/reports/view.html">
																			<span className="menu-bullet">
																				<span className="bullet bullet-dot"></span>
																			</span>
																			<span className="menu-title">Products Viewed</span>
																	...
																	<div className="menu-item">
																		{/*begin:Menu link*/}
																		<a className="menu-link py-3" href="../../demo6/dist/apps/ecommerce/reports/sales.html">
																			<span className="menu-bullet">
																				<span className="bullet bullet-dot"></span>
																			</span>
																			<span className="menu-title">Sales</span>
																	...
																	<div className="menu-item">
																		{/*begin:Menu link*/}
																		<a className="menu-link py-3" href="../../demo6/dist/apps/ecommerce/reports/returns.html">
																			<span className="menu-bullet">
																				<span className="bullet bullet-dot"></span>
																			</span>
																			<span className="menu-title">Returns</span>
																	...
																	<div className="menu-item">
																		{/*begin:Menu link*/}
																		<a className="menu-link py-3" href="../../demo6/dist/apps/ecommerce/reports/customer-orders.html">
																			<span className="menu-bullet">
																				<span className="bullet bullet-dot"></span>
																			</span>
																			<span className="menu-title">Customer Orders</span>
																	...
																	<div className="menu-item">
																		{/*begin:Menu link*/}
																		<a className="menu-link py-3" href="../../demo6/dist/apps/ecommerce/reports/shipping.html">
																			<span className="menu-bullet">
																				<span className="bullet bullet-dot"></span>
																			</span>
																			<span className="menu-title">Shipping</span>
															...
															<div className="menu-item">
																{/*begin:Menu link*/}
																<a className="menu-link py-3" href="../../demo6/dist/apps/ecommerce/settings.html">
																	<span className="menu-bullet">
																		<span className="bullet bullet-dot"></span>
																	</span>
																	<span className="menu-title">Settings</span>
													...
													<div data-kt-menu-trigger="{default:'click', lg: 'hover'}" data-kt-menu-placement="right-start" className="menu-item menu-lg-down-accordion">
														...
														<div className="menu-sub menu-sub-lg-down-accordion menu-sub-lg-dropdown menu-active-bg px-lg-2 py-lg-4 w-lg-225px">
															...
															<div className="menu-item">
																{/*begin:Menu link*/}
																<a className="menu-link py-3" href="../../demo6/dist/apps/support-center/overview.html">
																	<span className="menu-bullet">
																		<span className="bullet bullet-dot"></span>
																	</span>
																	<span className="menu-title">Overview</span>
															...
															<div data-kt-menu-trigger="{default:'click', lg: 'hover'}" data-kt-menu-placement="right-start" className="menu-item menu-lg-down-accordion">
																...
																<div className="menu-sub menu-sub-lg-down-accordion menu-sub-lg-dropdown menu-active-bg px-lg-2 py-lg-4 w-lg-225px">
																	...
																	<div className="menu-item">
																		{/*begin:Menu link*/}
																		<a className="menu-link py-3" href="../../demo6/dist/apps/support-center/tickets/list.html">
																			<span className="menu-bullet">
																				<span className="bullet bullet-dot"></span>
																			</span>
																	...
																	<div className="menu-item">
																		{/*begin:Menu link*/}
																		<a className="menu-link py-3" href="../../demo6/dist/apps/support-center/tickets/view.html">
																			<span className="menu-bullet">
																				<span className="bullet bullet-dot"></span>
																			</span>
															...
															<div data-kt-menu-trigger="{default:'click', lg: 'hover'}" data-kt-menu-placement="right-start" className="menu-item menu-lg-down-accordion">
																...
																<div className="menu-sub menu-sub-lg-down-accordion menu-sub-lg-dropdown menu-active-bg px-lg-2 py-lg-4 w-lg-225px">
																	...
																	<div className="menu-item">
																		{/*begin:Menu link*/}
																		<a className="menu-link py-3" href="../../demo6/dist/apps/support-center/tutorials/list.html">
																			<span className="menu-bullet">
																				<span className="bullet bullet-dot"></span>
																			</span>
																			<span className="menu-title">Tutorials List</span>
																	...
																	<div className="menu-item">
																		{/*begin:Menu link*/}
																		<a className="menu-link py-3" href="../../demo6/dist/apps/support-center/tutorials/post.html">
																			<span className="menu-bullet">
																				<span className="bullet bullet-dot"></span>
																			</span>
															...
															<div className="menu-item">
																{/*begin:Menu link*/}
																<a className="menu-link py-3" href="../../demo6/dist/apps/support-center/faq.html">
																	<span className="menu-bullet">
																		<span className="bullet bullet-dot"></span>
																	</span>
																	<span className="menu-title">FAQ</span>
															...
															<div className="menu-item">
																{/*begin:Menu link*/}
																<a className="menu-link py-3" href="../../demo6/dist/apps/support-center/licenses.html">
																	<span className="menu-bullet">
																		<span className="bullet bullet-dot"></span>
																	</span>
																	<span className="menu-title">Licenses</span>
															...
															<div className="menu-item">
																{/*begin:Menu link*/}
																<a className="menu-link py-3" href="../../demo6/dist/apps/support-center/contact.html">
																	<span className="menu-bullet">
																		<span className="bullet bullet-dot"></span>
																	</span>
																	<span className="menu-title">Contact Us</span>
														...
														<div className="menu-sub menu-sub-lg-down-accordion menu-sub-lg-dropdown menu-active-bg px-lg-2 py-lg-4 w-lg-225px">
															...
															<div data-kt-menu-trigger="{default:'click', lg: 'hover'}" data-kt-menu-placement="right-start" className="menu-item menu-lg-down-accordion">
																...
																<div className="menu-sub menu-sub-lg-down-accordion menu-sub-lg-dropdown menu-active-bg px-lg-2 py-lg-4 w-lg-225px">
																	...
																	<div className="menu-item">
																		{/*begin:Menu link*/}
																		<a className="menu-link py-3" href="../../demo6/dist/apps/user-management/users/list.html">
																			<span className="menu-bullet">
																				<span className="bullet bullet-dot"></span>
																			</span>
																			<span className="menu-title">Users List</span>
																	...
																	<div className="menu-item">
																		{/*begin:Menu link*/}
																		<a className="menu-link py-3" href="../../demo6/dist/apps/user-management/users/view.html">
																			<span className="menu-bullet">
																				<span className="bullet bullet-dot"></span>
																			</span>
																			<span className="menu-title">View User</span>
															...
															<div data-kt-menu-trigger="{default:'click', lg: 'hover'}" data-kt-menu-placement="right-start" className="menu-item menu-lg-down-accordion">
																...
																<div className="menu-sub menu-sub-lg-down-accordion menu-sub-lg-dropdown menu-active-bg px-lg-2 py-lg-4 w-lg-225px">
																	...
																	<div className="menu-item">
																		{/*begin:Menu link*/}
																		<a className="menu-link py-3" href="../../demo6/dist/apps/user-management/roles/list.html">
																			<span className="menu-bullet">
																				<span className="bullet bullet-dot"></span>
																			</span>
																			<span className="menu-title">Roles List</span>
																	...
																	<div className="menu-item">
																		{/*begin:Menu link*/}
																		<a className="menu-link py-3" href="../../demo6/dist/apps/user-management/roles/view.html">
																			<span className="menu-bullet">
																				<span className="bullet bullet-dot"></span>
																			</span>
															...
															<div className="menu-item">
																{/*begin:Menu link*/}
																<a className="menu-link py-3" href="../../demo6/dist/apps/user-management/permissions.html">
																	<span className="menu-bullet">
																		<span className="bullet bullet-dot"></span>
																	</span>
																	<span className="menu-title">Permissions</span>
													...
													<div data-kt-menu-trigger="{default:'click', lg: 'hover'}" data-kt-menu-placement="right-start" className="menu-item menu-lg-down-accordion">
														...
														<div className="menu-sub menu-sub-lg-down-accordion menu-sub-lg-dropdown menu-active-bg px-lg-2 py-lg-4 w-lg-225px">
															...
															<div className="menu-item">
																{/*begin:Menu link*/}
																<a className="menu-link py-3" href="../../demo6/dist/apps/contacts/getting-started.html">
																	<span className="menu-bullet">
																		<span className="bullet bullet-dot"></span>
																	</span>
																	<span className="menu-title">Getting Started</span>
															...
															<div className="menu-item">
																{/*begin:Menu link*/}
																<a className="menu-link py-3" href="../../demo6/dist/apps/contacts/add-contact.html">
																	<span className="menu-bullet">
																		<span className="bullet bullet-dot"></span>
																	</span>
																	<span className="menu-title">Add Contact</span>
															...
															<div className="menu-item">
																{/*begin:Menu link*/}
																<a className="menu-link py-3" href="../../demo6/dist/apps/contacts/edit-contact.html">
																	<span className="menu-bullet">
																		<span className="bullet bullet-dot"></span>
																	</span>
																	<span className="menu-title">Edit Contact</span>
															...
															<div className="menu-item">
																{/*begin:Menu link*/}
																<a className="menu-link py-3" href="../../demo6/dist/apps/contacts/view-contact.html">
																	<span className="menu-bullet">
																		<span className="bullet bullet-dot"></span>
																	</span>
																	<span className="menu-title">View Contact</span>
													...
													<div data-kt-menu-trigger="{default:'click', lg: 'hover'}" data-kt-menu-placement="right-start" className="menu-item menu-lg-down-accordion">
														...
														<div className="menu-sub menu-sub-lg-down-accordion menu-sub-lg-dropdown menu-active-bg px-lg-2 py-lg-4 w-lg-225px">
															...
															<div className="menu-item">
																{/*begin:Menu link*/}
																<a className="menu-link py-3" href="../../demo6/dist/apps/subscriptions/getting-started.html">
																	<span className="menu-bullet">
																		<span className="bullet bullet-dot"></span>
																	</span>
																	<span className="menu-title">Getting Started</span>
															...
															<div className="menu-item">
																{/*begin:Menu link*/}
																<a className="menu-link py-3" href="../../demo6/dist/apps/subscriptions/list.html">
																	<span className="menu-bullet">
																		<span className="bullet bullet-dot"></span>
																	</span>
																	<span className="menu-title">Subscription List</span>
															...
															<div className="menu-item">
																{/*begin:Menu link*/}
																<a className="menu-link py-3" href="../../demo6/dist/apps/subscriptions/add.html">
																	<span className="menu-bullet">
																		<span className="bullet bullet-dot"></span>
																	</span>
																	<span className="menu-title">Add Subscription</span>
															...
															<div className="menu-item">
																{/*begin:Menu link*/}
																<a className="menu-link py-3" href="../../demo6/dist/apps/subscriptions/view.html">
																	<span className="menu-bullet">
																		<span className="bullet bullet-dot"></span>
																	</span>
																	<span className="menu-title">View Subscription</span>
													...
													<div data-kt-menu-trigger="{default:'click', lg: 'hover'}" data-kt-menu-placement="right-start" className="menu-item menu-lg-down-accordion">
														...
														<div className="menu-sub menu-sub-lg-down-accordion menu-sub-lg-dropdown menu-active-bg px-lg-2 py-lg-4 w-lg-225px">
															...
															<div className="menu-item">
																{/*begin:Menu link*/}
																<a className="menu-link py-3" href="../../demo6/dist/apps/customers/getting-started.html">
																	<span className="menu-bullet">
																		<span className="bullet bullet-dot"></span>
																	</span>
																	<span className="menu-title">Getting Started</span>
															...
															<div className="menu-item">
																{/*begin:Menu link*/}
																<a className="menu-link py-3" href="../../demo6/dist/apps/customers/list.html">
																	<span className="menu-bullet">
																		<span className="bullet bullet-dot"></span>
																	</span>
																	<span className="menu-title">Customer Listing</span>
															...
															<div className="menu-item">
																{/*begin:Menu link*/}
																<a className="menu-link py-3" href="../../demo6/dist/apps/customers/view.html">
																	<span className="menu-bullet">
																		<span className="bullet bullet-dot"></span>
																	</span>
																	<span className="menu-title">Customer Details</span>
														...
														<div className="menu-sub menu-sub-lg-down-accordion menu-sub-lg-dropdown menu-active-bg px-lg-2 py-lg-4 w-lg-225px">
															...
															<div data-kt-menu-trigger="{default:'click', lg: 'hover'}" data-kt-menu-placement="right-start" className="menu-item menu-lg-down-accordion">
																...
																<div className="menu-sub menu-sub-lg-down-accordion menu-sub-lg-dropdown menu-active-bg px-lg-2 py-lg-4 w-lg-225px">
																	...
																	<div className="menu-item">
																		{/*begin:Menu link*/}
																		<a className="menu-link py-3" href="../../demo6/dist/apps/invoices/view/invoice-1.html">
																			<span className="menu-bullet">
																				<span className="bullet bullet-dot"></span>
																			</span>
																			<span className="menu-title">Invoice 1</span>
																	...
																	<div className="menu-item">
																		{/*begin:Menu link*/}
																		<a className="menu-link py-3" href="../../demo6/dist/apps/invoices/view/invoice-2.html">
																			<span className="menu-bullet">
																				<span className="bullet bullet-dot"></span>
																			</span>
																			<span className="menu-title">Invoice 2</span>
																	...
																	<div className="menu-item">
																		{/*begin:Menu link*/}
																		<a className="menu-link py-3" href="../../demo6/dist/apps/invoices/view/invoice-3.html">
																			<span className="menu-bullet">
																				<span className="bullet bullet-dot"></span>
																			</span>
																			<span className="menu-title">Invoice 3</span>
															...
															<div className="menu-item">
																{/*begin:Menu link*/}
																<a className="menu-link py-3" href="../../demo6/dist/apps/invoices/create.html">
																	<span className="menu-bullet">
																		<span className="bullet bullet-dot"></span>
																	</span>
																	<span className="menu-title">Create Invoice</span>
													...
													<div data-kt-menu-trigger="{default:'click', lg: 'hover'}" data-kt-menu-placement="right-start" className="menu-item menu-lg-down-accordion">
														...
														<div className="menu-sub menu-sub-lg-down-accordion menu-sub-lg-dropdown menu-active-bg px-lg-2 py-lg-4 w-lg-225px">
															...
															<div className="menu-item">
																{/*begin:Menu link*/}
																<a className="menu-link py-3" href="../../demo6/dist/apps/file-manager/folders.html">
																	<span className="menu-bullet">
																		<span className="bullet bullet-dot"></span>
																	</span>
																	<span className="menu-title">Folders</span>
															...
															<div className="menu-item">
																{/*begin:Menu link*/}
																<a className="menu-link py-3" href="../../demo6/dist/apps/file-manager/files.html">
																	<span className="menu-bullet">
																		<span className="bullet bullet-dot"></span>
																	</span>
																	<span className="menu-title">Files</span>
															...
															<div className="menu-item">
																{/*begin:Menu link*/}
																<a className="menu-link py-3" href="../../demo6/dist/apps/file-manager/blank.html">
																	<span className="menu-bullet">
																		<span className="bullet bullet-dot"></span>
																	</span>
																	<span className="menu-title">Blank Directory</span>
															...
															<div className="menu-item">
																{/*begin:Menu link*/}
																<a className="menu-link py-3" href="../../demo6/dist/apps/file-manager/settings.html">
																	<span className="menu-bullet">
																		<span className="bullet bullet-dot"></span>
																	</span>
																	<span className="menu-title">Settings</span>
													...
													<div data-kt-menu-trigger="{default:'click', lg: 'hover'}" data-kt-menu-placement="right-start" className="menu-item menu-lg-down-accordion">
														...
														<div className="menu-sub menu-sub-lg-down-accordion menu-sub-lg-dropdown menu-active-bg px-lg-2 py-lg-4 w-lg-225px">
															...
															<div className="menu-item">
																{/*begin:Menu link*/}
																<a className="menu-link py-3" href="../../demo6/dist/apps/inbox/listing.html">
																	<span className="menu-bullet">
																		<span className="bullet bullet-dot"></span>
																	</span>
																	<span className="menu-title">Messages</span>
															...
															<div className="menu-item">
																{/*begin:Menu link*/}
																<a className="menu-link py-3" href="../../demo6/dist/apps/inbox/compose.html">
																	<span className="menu-bullet">
																		<span className="bullet bullet-dot"></span>
																	</span>
																	<span className="menu-title">Compose</span>
															...
															<div className="menu-item">
																{/*begin:Menu link*/}
																<a className="menu-link py-3" href="../../demo6/dist/apps/inbox/reply.html">
																	<span className="menu-bullet">
																		<span className="bullet bullet-dot"></span>
																	</span>
																	<span className="menu-title">View & Reply</span>
													...
													<div data-kt-menu-trigger="{default:'click', lg: 'hover'}" data-kt-menu-placement="right-start" className="menu-item menu-lg-down-accordion">
														...
														<div className="menu-sub menu-sub-lg-down-accordion menu-sub-lg-dropdown menu-active-bg px-lg-2 py-lg-4 w-lg-225px">
															...
															<div className="menu-item">
																{/*begin:Menu link*/}
																<a className="menu-link py-3" href="../../demo6/dist/apps/chat/private.html">
																	<span className="menu-bullet">
																		<span className="bullet bullet-dot"></span>
																	</span>
																	<span className="menu-title">Private Chat</span>
															...
															<div className="menu-item">
																{/*begin:Menu link*/}
																<a className="menu-link py-3" href="../../demo6/dist/apps/chat/group.html">
																	<span className="menu-bullet">
																		<span className="bullet bullet-dot"></span>
																	</span>
																	<span className="menu-title">Group Chat</span>
															...
															<div className="menu-item">
																{/*begin:Menu link*/}
																<a className="menu-link py-3" href="../../demo6/dist/apps/chat/drawer.html">
																	<span className="menu-bullet">
																		<span className="bullet bullet-dot"></span>
																	</span>
																	<span className="menu-title">Drawer Chat</span>
													...
													<div className="menu-item">
														{/*begin:Menu link*/}
														<a className="menu-link py-3" href="../../demo6/dist/apps/calendar.html">
															<span className="menu-icon">
																<i className="bi bi-calendar3-event fs-3"></i>
															</span>
															<span className="menu-title">Calendar</span>
								...
								<div className="d-flex align-items-stretch flex-shrink-0">
											...
											<div data-kt-search-element="content" className="menu menu-sub menu-sub-dropdown p-7 w-325px w-md-375px">
												...
												<form data-kt-search-element="advanced-options-form" className="pt-1 d-none">
													...
													<div className="d-flex justify-content-end">
														...
														<a href="../../demo6/dist/pages/search/horizontal.html" className="btn btn-sm fw-bold btn-primary" data-kt-search-element="advanced-options-form-search">Search</a>
													</div>
													{/*end::Actions*/}
												</form>
												{/*end::Preferences*/}
									...
									<div className="d-flex align-items-center ms-1 ms-lg-3">
										...
										<div className="menu menu-sub menu-sub-dropdown menu-column w-250px w-lg-325px" data-kt-menu="true">
											{/*begin::Heading*/}
											{/* <div className="d-flex flex-column flex-center bgi-no-repeat rounded-top px-9 py-10" style="background-image:url('assets/media/misc/menu-header-bg.jpg')"> */}
												{/*begin::Title*/}
												{/* <h3 className="text-white fw-semibold mb-3">Quick Links</h3> */}
												{/*end::Title*/}
												{/*begin::Status*/}
												<span className="badge bg-primary py-2 px-3">25 pending deals</span>
												{/*end::Status*/}
											</div>
											{/*end::Heading*/}
											{/*begin:Nav*/}
									...
									<div className="d-flex align-items-center ms-1 ms-lg-3">
										{/*begin::Menu wrapper*/}
										<div className="btn btn-icon btn-active-light-primary position-relative btn btn-icon btn-active-light-primary w-30px h-30px w-md-40px h-md-40px pulse pulse-success" id="kt_drawer_chat_toggle">
									...
									<div className="d-flex align-items-center ms-1 ms-lg-3">
										{/*begin::Menu- wrapper*/}
										<div className="btn btn-icon btn-active-light-primary w-30px h-30px w-md-40px h-md-40px position-relative" data-kt-menu-trigger="click" data-kt-menu-attach="parent" data-kt-menu-placement="bottom-end">
										...
										<div className="menu menu-sub menu-sub-dropdown menu-column w-350px w-lg-375px" data-kt-menu="true">
											{/*begin::Heading*/}
											{/* <div className="d-flex flex-column bgi-no-repeat rounded-top" style="background-image:url('assets/media/misc/menu-header-bg.jpg')"> */}
												{/*begin::Title*/}
													...
													<div className="scroll-y mh-325px my-5 px-8">
														...
														<div className="d-flex flex-stack py-4">
															...
															<div className="d-flex align-items-center me-2">
																...
																{/*end::Code*/}
																{/*begin::Title*/}
																<a href="#" className="text-gray-800 text-hover-primary fw-semibold">Mail deals</a>
																{/*end::Title*/}
															</div>
															{/*end::Section*/}
															{/*begin::Label*/}
					...
					<div className="toolbar py-2" id="kt_toolbar">
						{/*begin::Container*/}
						<div id="kt_toolbar_container" className="container-fluid d-flex align-items-center">
							{/*begin::Page title*/}
							<div className="flex-grow-1 flex-shrink-0 me-5">
								{/*begin::Page title*/}
								<div data-kt-swapper="true" data-kt-swapper-mode="prepend" data-kt-swapper-parent="{default: '#kt_content_container', 'lg': '#kt_toolbar_container'}" className="page-title d-flex align-items-center flex-wrap me-3 mb-5 mb-lg-0">
									{/*begin::Title*/}
									<h1 className="d-flex align-items-center text-dark fw-bold my-1 fs-3">Product Form</h1>
									{/*end::Title*/}
									{/*begin::Separator*/}
									...
									<ul className="breadcrumb breadcrumb-separatorless fw-semibold fs-7 my-1">
										...
										<li className="breadcrumb-item text-muted">
											<a href="../../demo6/dist/index.html" className="text-muted text-hover-primary">Home</a>
										</li>
										{/*end::Item*/}
										{/*begin::Item*/}
										...
										{/*end::Item*/}
										{/*begin::Item*/}
										<li className="breadcrumb-item text-dark">Add Product</li>
										{/*end::Item*/}
									</ul>
									{/*end::Breadcrumb*/}
								</div>
							...
							<div className="d-flex align-items-center flex-wrap">
								...
								<div className="flex-shrink-0 me-2">
									<ul className="nav">
										<li className="nav-item">
											<a className="nav-link btn btn-sm btn-color-muted btn-active-color-primary btn-active-light active fw-semibold fs-7 px-4 me-1" data-bs-toggle="tab" href="#">Day</a>
										</li>
										<li className="nav-item">
											<a className="nav-link btn btn-sm btn-color-muted btn-active-color-primary btn-active-light fw-semibold fs-7 px-4 me-1" data-bs-toggle="tab" href="">Week</a>
										</li>
										<li className="nav-item">
											<a className="nav-link btn btn-sm btn-color-muted btn-active-color-primary btn-active-light fw-semibold fs-7 px-4" data-bs-toggle="tab" href="#">Year</a>
										</li>
									</ul>
								</div>
								{/*end::Wrapper*/}
								...
								<div className="d-flex align-items-center">
									...
									<a href="#" className="btn btn-sm btn-bg-light btn-color-gray-500 btn-active-color-primary me-2" id="kt_dashboard_daterangepicker" data-bs-toggle="tooltip" data-bs-dismiss="click" data-bs-trigger="hover" title="Select dashboard daterange">
										<span className="fw-semibold me-1" id="kt_dashboard_daterangepicker_title">Range:</span>
										<span className="fw-bold" id="kt_dashboard_daterangepicker_date">September 12</span>
									</a>
									{/*end::Daterangepicker*/}
									{/*begin::Actions*/}
									<div className="d-flex align-items-center">
										<button type="button" className="btn btn-sm btn-icon btn-color-primary btn-active-light btn-active-color-primary" data-bs-toggle="modal" data-bs-target="#kt_modal_create_campaign">
					...
					<div className="content d-flex flex-column flex-column-fluid" id="kt_content">
						...
						<div id="kt_content_container" className="container-xxl">
							{/*begin::Form*/}
							<form id="kt_ecommerce_add_product_form" className="form d-flex flex-column flex-lg-row" data-kt-redirect="../../demo6/dist/apps/ecommerce/catalog/products.html">
								{/*begin::Aside column*/}
								<div className="d-flex flex-column gap-7 gap-lg-10 w-100 w-lg-300px mb-7 me-lg-10">
									...
									<div className="card card-flush py-4">
										...
										<div className="card-body pt-0">
											...
											{/*end::Input group*/}
											{/*begin::Button*/}
											<a href="../../demo6/dist/apps/ecommerce/catalog/add-category.html" className="btn btn-light-primary btn-sm mb-10">
								...
								<div className="d-flex flex-column flex-row-fluid gap-7 gap-lg-10">
												...
												<div className="card card-flush py-4">
													...
													<div className="card-body pt-0">
														...
														<div className="fv-row mb-10">
															...
															<i className="fas fa-exclamation-circle ms-2 fs-7" data-bs-toggle="tooltip" title="Select a discount type that will be applied to this product"></i></label>
															{/*End::Label*/}
															{/*begin::Row*/}
									...
									<div className="d-flex justify-content-end">
										{/*begin::Button*/}
										<a href="../../demo6/dist/apps/ecommerce/catalog/products.html" id="kt_ecommerce_add_product_cancel" className="btn btn-light me-5">Cancel</a>
										{/*end::Button*/}
										{/*begin::Button*/}
		...
		<div id="kt_activities" className="bg-body" data-kt-drawer="true" data-kt-drawer-name="activities" data-kt-drawer-activate="true" data-kt-drawer-overlay="true" data-kt-drawer-width="{default:'300px', 'lg': '900px'}" data-kt-drawer-direction="end" data-kt-drawer-toggle="#kt_activities_toggle" data-kt-drawer-close="#kt_activities_close">
			<div className="card shadow-none border-0 rounded-0">
						...
						<div className="timeline">
							...
							<div className="timeline-item">
								...
								<div className="timeline-content mb-10 mt-n1">
									...
									<div className="pe-3 mb-5">
										{/*begin::Title*/}
										<div className="fs-5 fw-semibold mb-2">There are 2 new deals for you in “AirPlus Mobile App” project:</div>
										{/*end::Title*/}
										{/*begin::Description*/}
									...
									<div className="overflow-auto pb-5">
										...
										<div className="d-flex align-items-center border border-dashed border-gray-300 rounded min-w-750px px-7 py-3 mb-5">
											{/*begin::Title*/}
											<a href="../../demo6/dist/apps/projects/project.html" className="fs-5 text-dark text-hover-primary fw-semibold w-375px min-w-200px">Meeting with customer</a>
											{/*end::Title*/}
											{/*begin::Label*/}
											...
											{/*end::Progress*/}
											{/*begin::Action*/}
											<a href="../../demo6/dist/apps/projects/project.html" className="btn btn-sm btn-light btn-active-light-primary">View</a>
											{/*end::Action*/}
										</div>
										{/*end::Record*/}
										{/*begin::Record*/}
										<div className="d-flex align-items-center border border-dashed border-gray-300 rounded min-w-750px px-7 py-3 mb-0">
											{/*begin::Title*/}
											<a href="../../demo6/dist/apps/projects/project.html" className="fs-5 text-dark text-hover-primary fw-semibold w-375px min-w-200px">Project Delivery Preparation</a>
											{/*end::Title*/}
											{/*begin::Label*/}
										...
										<div className="d-flex align-items-center border border-dashed border-gray-300 rounded min-w-700px p-5">
											...
											<div className="d-flex flex-aligns-center pe-10 pe-lg-20">
												...
												<div className="ms-1 fw-semibold">
													{/*begin::Desc*/}
													<a href="../../demo6/dist/apps/projects/project.html" className="fs-6 text-hover-primary fw-bold">Finance KPI App Guidelines</a>
													{/*end::Desc*/}
													{/*begin::Number*/}
											...
											<div className="d-flex flex-aligns-center pe-10 pe-lg-20">
												{/*begin::Icon*/}
												<img alt="../../demo6/dist/apps/projects/project.html" className="w-30px me-3" src="assets/media/svg/files/doc.svg" />
												{/*end::Icon*/}
												{/*begin::Info*/}
												<div className="ms-1 fw-semibold">
													{/*begin::Desc*/}
											...
											<div className="d-flex flex-aligns-center">
												{/*begin::Icon*/}
												<img alt="../../demo6/dist/apps/projects/project.html" className="w-30px me-3" src="assets/media/svg/files/css.svg" />
												{/*end::Icon*/}
												{/*begin::Info*/}
												<div className="ms-1 fw-semibold">
													{/*begin::Desc*/}
							...
							<div className="timeline-item">
								...
								<div className="timeline-content mb-10 mt-n1">
									...
									<div className="pe-3 mb-5">
										{/*begin::Title*/}
										<div className="fs-5 fw-semibold mb-2">Deal
				...
				<div className="card-footer py-5 text-center" id="kt_activities_footer">
					<a href="../../demo6/dist/pages/user-profile/activity.html" className="btn btn-bg-body text-primary">View All Activities
					{/*begin::Svg Icon | path: icons/duotune/arrows/arr064.svg*/}
		...
		<div className="engage-toolbar d-flex position-fixed px-5 fw-bold zindex-2 top-50 end-0 transform-90 mt-5 mt-lg-20 gap-2">
			...
			<button id="kt_engage_demos_toggle" className="engage-demos-toggle engage-btn btn shadow-sm fs-6 px-4 rounded-top-0" title="Check out 22 more demos" data-bs-toggle="tooltip" data-bs-placement="left" data-bs-dismiss="click" data-bs-trigger="hover">
		...
		<div className="modal fade" id="kt_modal_upgrade_plan">
			{/*begin::Modal dialog*/}
		...
		<div className="modal fade" id="kt_modal_create_campaign">
			{/*begin::Modal dialog*/}
				...
				<div className="modal-content modal-rounded">
					...
					<div className="modal-body scroll-y m-5">
						...
						<div className="stepper stepper-links d-flex flex-column" id="kt_modal_create_campaign_stepper">
							...
							{/*end::Nav*/}
							{/*begin::Form*/}
							<form className="mx-auto w-100 mw-600px pt-15 pb-10">
								{/*begin::Step 1*/}
								<div className="current" data-kt-stepper-element="content">
									...
									<div className="w-100">
										...
										<div className="pb-10 pb-lg-15">
											...
											<i className="fas fa-exclamation-circle ms-2 fs-7" data-bs-toggle="tooltip" title="Campaign name will be used as reference within your campaign reports"></i></h2>
											{/*end::Title*/}
											{/*begin::Notice*/}
								...
								<div data-kt-stepper-element="content">
									...
									<div className="w-100">
										...
										<div className="fv-row mb-10">
											...
											<i className="fas fa-exclamation-circle ms-2 fs-7" data-bs-toggle="tooltip" title="Show your ads to either men or women, or select 'All' for both"></i></label>
											{/*End::Label*/}
											{/*begin::Row*/}
										...
										<div className="fv-row mb-10">
											...
											<i className="fas fa-exclamation-circle ms-2 fs-7" data-bs-toggle="tooltip" title="Select the minimum and maximum age of the people who will find your ad relevant."></i></label>
											{/*End::Label*/}
											{/*begin::Slider*/}
											<div className="d-flex flex-stack">
										...
										<div className="fv-row mb-10">
											...
											<i className="fas fa-exclamation-circle ms-2 fs-7" data-bs-toggle="tooltip" title="Enter one or more location points for more specific targeting."></i></label>
											{/*End::Label*/}
											{/*begin::Tagify*/}
								...
								<div data-kt-stepper-element="content">
									...
									<div className="w-100">
										...
										<div className="fv-row mb-10">
											...
											<i className="fas fa-exclamation-circle ms-2 fs-7" data-bs-toggle="tooltip" title="Choose how long you want your ad to run for"></i></label>
											{/*end::Label*/}
										...
										<div className="fv-row mb-10">
											...
											<i className="fas fa-exclamation-circle ms-2 fs-7" data-bs-toggle="tooltip" title="Choose the budget allocated for each day. Higher budget will generate better results"></i></label>
											{/*end::Label*/}
											{/*begin::Slider*/}
		...
		<div className="modal fade" id="kt_modal_users_search">
			{/*begin::Modal dialog*/}
      ...
      {(formik.isSubmitting || isDealLoading) && <DealsListLoading />}
    </>
  )
}
