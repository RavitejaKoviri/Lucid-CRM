            ...
            <div className="card">
              <div className="card-header align-items-center py-5 gap-5">
                ...
                <div className="d-flex">
                  {/*begin::Back*/}
                  <a href="../../demo6/dist/apps/inbox/listing.html" className="btn btn-sm btn-icon btn-clear btn-active-light-primary me-3" data-bs-toggle="tooltip" data-bs-placement="top" title="Back">
                ...
                <div className="d-flex align-items-center">
                  {/*begin::Pages info*/}
                  <span className="fw-semibold text-muted me-2">1 - 50 of 235</span>
                  {/*end::Pages info*/}
                  {/*begin::Prev page*/}
                  ...
                  {/*begin::Settings menu*/}
                  <div>
                    <a href="#" className="btn btn-sm btn-icon btn-light btn-active-light-primary" data-kt-menu-trigger="click" data-kt-menu-placement="bottom-end" data-bs-toggle="tooltip" data-bs-placement="top" title="Settings">
                    ...
                    <div className="menu menu-sub menu-sub-dropdown menu-column menu-rounded menu-gray-600 menu-state-bg-light-primary fw-semibold fs-7 w-250px py-4" data-kt-menu="true">
                      ...
                      <div className="menu-item px-3">
                        ...
                        {/*end::Svg Icon*/}Groups
                        <span className="badge badge-light-primary ms-auto">new</span></a>
                      </div>
                      {/*end::Menu item*/}
                      {/*begin::Menu item*/}
                      <div className="menu-item px-3">
                      ...
                      <div className="menu-item px-3">
                        ...
                        <span className="badge badge-light-danger ms-auto">5</span></a>
                      </div>
                      {/*end::Menu item*/}
                    </div>
                    {/*end::Menu*/}
              ...
              <div className="card-body">
                ...
                <div className="d-flex flex-wrap gap-2 justify-content-between mb-8">
                  <div className="d-flex align-items-center flex-wrap gap-2">
                    {/*begin::Heading*/}
                    <h2 className="fw-semibold me-3 my-1">Trip Reminder. Thank you for flying with us!</h2>
                    {/*begin::Heading*/}
                    {/*begin::Badges*/}
                  ...
                  <div className="d-flex">
                    ...
                    <a href="#" className="btn btn-sm btn-icon btn-light btn-active-light-primary me-2" data-bs-toggle="tooltip" data-bs-placement="top" title="Print">
                      <i className="bi bi-printer-fill fs-2"></i>
                    </a>
                    {/*end::Print*/}
                  </div>
                </div>
                ...
                <div data-kt-inbox-message="message_wrapper">
                  ...
                  <div className="d-flex flex-wrap gap-2 flex-stack cursor-pointer" data-kt-inbox-message="header">
                    ...
                    <div className="d-flex align-items-center">
                      ...
                      <div className="pe-5">
                        ...
                        <div className="d-flex align-items-center flex-wrap gap-1">
                          <a href="#" className="fw-bold text-dark text-hover-primary">Emma Smith</a>
                    ...
                    <div className="d-flex align-items-center flex-wrap gap-2">
                      {/*begin::Date*/}
                      <span className="fw-semibold text-muted text-end me-3">05 May 2022, 6:05 pm</span>
                      {/*end::Date*/}
                      <div className="d-flex">
                        {/*begin::Star*/}
                        ...
                        {/*begin::Reply*/}
                        <a href="#" className="btn btn-sm btn-icon btn-clear btn-active-light-primary me-3" data-bs-toggle="tooltip" data-bs-placement="top" title="Reply">
                        ...
                        {/*end::Reply*/}
                        {/*begin::Settings*/}
                        <a href="#" className="btn btn-sm btn-icon btn-clear btn-active-light-primary" data-bs-toggle="tooltip" data-bs-placement="top" title="Settings">
                ...
                <div data-kt-inbox-message="message_wrapper">
                  ...
                  <div className="d-flex flex-wrap gap-2 flex-stack cursor-pointer" data-kt-inbox-message="header">
                    ...
                    <div className="d-flex align-items-center flex-wrap gap-2">
                      {/*begin::Date*/}
                      <span className="fw-semibold text-muted text-end me-3">22 Sep 2022, 6:05 pm</span>
                      {/*end::Date*/}
                      <div className="d-flex">
                        {/*begin::Star*/}
                        <a href="#" className="btn btn-sm btn-icon btn-clear btn-active-light-primary me-3" data-bs-toggle="tooltip" data-bs-placement="top" title="Star">
                ...
                <div data-kt-inbox-message="message_wrapper">
                  ...
                  <div className="d-flex flex-wrap gap-2 flex-stack cursor-pointer" data-kt-inbox-message="header">
                    ...
                    <div className="d-flex align-items-center flex-wrap gap-2">
                      {/*begin::Date*/}
                      <span className="fw-semibold text-muted text-end me-3">25 Jul 2022, 10:30 am</span>
                      {/*end::Date*/}
                      <div className="d-flex">
                        {/*begin::Star*/}
                        <a href="#" className="btn btn-sm btn-icon btn-clear btn-active-light-primary me-3" data-bs-toggle="tooltip" data-bs-placement="top" title="Star">
                ...
                <form id="kt_inbox_reply_form" className="rounded border mt-10">
                  ...
                  <div className="d-block">
                    ...
                    <div className="d-flex align-items-center border-bottom px-8 min-h-50px">
                      ...
                      {/*end::Label*/}
                      {/*begin::Input*/}
                      <input type="text" className="form-control border-0" name="compose_to" value="e.smith@kpmg.com.au, max@kt.com, sean@dellito.com" data-kt-inbox-form="tagify" />
                      {/*end::Input*/}
                    ...
                    <div className="d-none align-items-center border-bottom ps-8 pe-5 min-h-50px" data-kt-inbox-form="cc">
                      ...
                      {/*end::Label*/}
                      {/*begin::Input*/}
                      <input type="text" className="form-control border-0" name="compose_cc" value="" data-kt-inbox-form="tagify" />
                      {/*end::Input*/}
                      {/*begin::Close*/}
                    ...
                    <div className="d-none align-items-center border-bottom inbox-to-bcc ps-8 pe-5 min-h-50px" data-kt-inbox-form="bcc">
                      ...
                      {/*end::Label*/}
                      {/*begin::Input*/}
                      <input type="text" className="form-control border-0" name="compose_bcc" value="" data-kt-inbox-form="tagify" />
                      {/*end::Input*/}
                      {/*begin::Close*/}
                    ...
                    {/*end::Subject*/}
                    {/*begin::Message*/}
                    <div id="kt_inbox_form_editor" className="border-0 h-250px px-3"></div>
                    {/*end::Message*/}
                    {/*begin::Attachments*/}
                    ...
                    <div className="d-flex align-items-center me-3">
                      ...
                      <div className="btn-group me-4">
                        ...
                        <span className="btn btn-primary btn-icon fs-bold" role="button">
                          <span className="btn btn-icon" data-kt-menu-trigger="click" data-kt-menu-placement="top-start">
                            {/*begin::Svg Icon | path: icons/duotune/arrows/arr072.svg*/}
                            <span className="svg-icon svg-icon-2 m-0">
                              <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                                <path d="M11.4343 12.7344L7.25 8.55005C6.83579 8.13583 6.16421 8.13584 5.75 8.55005C5.33579 8.96426 5.33579 9.63583 5.75 10.05L11.2929 15.5929C11.6834 15.9835 12.3166 15.9835 12.7071 15.5929L18.25 10.05C18.6642 9.63584 18.6642 8.96426 18.25 8.55005C17.8358 8.13584 17.1642 8.13584 16.75 8.55005L12.5657 12.7344C12.2533 13.0468 11.7467 13.0468 11.4343 12.7344Z" fill="currentColor" />
