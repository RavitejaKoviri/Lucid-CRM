...
const TargetIndex = () => {
  ...
  function handleCardMove(board, card, source, destination) {
    axios
      .get(
        `https://crmbackend.luciddiagnostics.com/target-statuses?targetStatusName=${destination?.toColumnId}`,
        {
          headers: {
                      ...
                      <>
                        <div>
                          <button
                            ...
                            className="btn btn-sm btn-icon btn-color-light-dark btn-active-light-primary"
                            onClick={() => {
                              navigation("EditTarget", { state: { id } });
                            }}
                          >
                            {/* begin::Svg Icon | path: icons/duotune/general/gen024.svg */}
                            <svg
                        ...
                        <div>
                          <button
                            ...
                            className="btn btn-sm btn-icon btn-color-light-dark btn-active-light-primary"
                            onClick={() => {
                              dispatch(DeleteTarget(id, token));
                            }}
                          >
                            {/* begin::Svg Icon | path: icons/duotune/general/gen024.svg */}
                            <svg
