...
import { DeleteTickets, getAllTickets, getticketsById, UpdateTickets } from "../_redux/ticketAction";
...
const TicketIndex = () => {
  ...
  const handleClickOpen = (id) => {
    dispatch(getticketsById(id, token))
    setOpen(true);
  };
    ...
    <>
      <div className="tab-content">
        <Board
          ...
          renderCard={({ id, ticketPriority, ticketName }, { dragging }) => (
            <div
              style={{
                display: "block",
              ...
              <div className='form-group row mb-2'>
                ...
                <label className='col-lg-12 col-form-label fw-bold fs-6'>
                  ...
                  <input
                    ...
                    value={ticket?.ticketAssignedTo?.username}
                  />
                  <div className='fv-plugins-message-container'>
                    <div className='fv-help-block'></div>
                  </div>
                ...
                <label className='col-lg-12 col-form-label fw-bold fs-6'>
                  ...
                  <input
                    ...
                    value={ticket?.customer?.customerName}
                  />
                  <div className='fv-plugins-message-container'>
                    <div className='fv-help-block'></div>
                  </div>
              ...
              <div className='form-group row mb-2'>
                ...
                <label className='col-lg-8 col-form-label fw-bold fs-6'>
                  ...
                  <input
                    type='text'
                    className='form-control form-control-lg form-control-solid'
                    placeholder='Status website'
                    value={ticket?.ticketStatus?.ticketStatusName}
                  />
                  <div className='fv-plugins-message-container'>
                    <div className='fv-help-block'></div>
                  </div>
