...
const PrivateRoutes = () => {
  ...
  const DepartmentPage = lazy(
    () => import("../modules/Department/DepartmentPage")
  );
  ...
  return (
    <Routes>
      ...
      <Route element={<MasterLayout />}>
        ...
        <Route
          path="team-members/team-members/adduser"
          element={<UserAdduser />}
        />
        <Route path="leads/list/leadadduser" element={<LeadAdduser />} />
        <Route path="leads/list/EditLead" element={<EditLead />} />
        <Route
          path="team-members/team-members/EditUser"
          element={<EditUser />}
        />
        <Route
          path="bookings/bookings/bookingadduser"
          element={<BookingAdduser />}
        />
        ...
        <Route
          path="department/department/addDepartment"
          element={<AddDepartment />}
        />
        <Route
          path="department/department/EditDepartment"
        ...
        <Route
          path="campaigns/campaigns/campaignadduser"
          element={<CampaignAdduser />}
        />
        <Route
          path="campaigns/campaigns/EditCampaign"
          element={<EditCampaign />}
        />
        <Route
          path="campaigns/campaigns/campaigncreate"
          element={<CampaignCreate />}
        />
        <Route
          path="campaigns/campaigns/campaigncreate/signupform"
          element={<SignupForm />}
        />
        <Route
          path="campaigns/campaigns/campaigncreate/signupform/form"
          element={<FormBuilder />}
        />
        <Route
          path="campaigns/campaigns/campaigncreate/signupform/templates"
          element={<Templates />}
        />
        <Route
          path="campaigns/campaigns/campaigncreate/emailcampaign"
          element={<EmailCampaign />}
        />
        <Route
          path="campaigns/campaigns/campaigncreate/automation"
          element={<CampaignAutomation />}
        />
        <Route
          path="campaigns/campaigns/campaigncreate/socialcampaign"
          element={<SocialCampaigns />}
        />
        <Route
          path="campaigns/campaigns/campaigncreate/socialcampaign/socialmediapost"
          element={<SocialMediaPost />}
        />
        <Route
          path="campaigns/campaigns/campaigncreate/socialcampaign/facebookpost"
          element={<FacebookPost />}
        />
        <Route
          path="campaigns/campaigns/campaigncreate/signupform/templates/signupformtemplate"
          element={<SignUpFormTemplate />}
        />
        <Route
          path="campaigns/campaigns/campaigncreate/signupform/templates/signupformtemplate/response"
          element={<TempResponse />}
        />
        <Route
          path="campaigns/campaigns/campaigncreate/emailcampaign"
          element={<EmailCampaign />}
        ...
        <Route
          path="contacts/contacts/contactaddcontact"
          element={<ContactsAdduser />}
        />
        ...
        />
        <Route
          path="/apps/user-management/roles/list/addnewrole"
          element={<AddNewRole />}
        />
        <Route
          path="/apps/user-management/roles/view"
          element={<ViewRoles />}
        />
        <Route
          path="/apps/user-management/roles/permissions"
        ...
        <Route
          path="company/*"
          element={<SuspensedView>{/* <CompanyPage /> */}</SuspensedView>}
        />
        {/* Page Not Found */}
