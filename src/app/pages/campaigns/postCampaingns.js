          ...
          <div className='page d-flex flex-row flex-column-fluid'>
            ...
            <div className='wrapper d-flex flex-column flex-row-fluid' id='kt_wrapper' style={{backgroundColor:"#ffffff"}}>
              ...
              <div id='kt_content' className='content d-flex flex-column flex-column-fluid' style={{backgroundColor:"#ffffff",marginTop:'-5rem'}}>
                ...
                <div style={{ fontFamily: 'Segoe UI',fontWeight: 400,fontSize:" 20px",color: "#000000"}}>Post Campaigns </div>
                ...
                <div style={{display:"flex",justifyContent:'space-around'}}>
                    <div style={{textAlign:"center",borderRadius:'5px', boxShadow:"0px 0px 6px rgba(0,0,0,0.16)",padding:"3rem  3rem 2rem 3rem",width:'45%'}}>
                        <div style={{fontFamily: 'Segoe UI',fontStyle: "normal",fontWeight: 600,fontSize: "16px",lineHeight: "21px",color: "#000000",marginBottom:"1rem"}}>Regular Post Campaigns</div>
                        <div><ChatIcon style={{marginBottom:"1rem",color:'#638CE8',height:"92px",width:"92px"}}/></div>
                        <div style={{fontFamily: 'Montserrat',fontStyle: "normal",fontWeight: 400,fontSize: "10px",lineHeight: "12px",color: "#282828",marginBottom:"1rem"}} >Engaga with your audience through social media
                                   updates</div>
                    </div>
                    <div style={{textAlign:"center",borderRadius:'5px', boxShadow:"0px 0px 6px rgba(0,0,0,0.16)",padding:"3rem  3rem 2rem 3rem",width:"45%"}}>
                        <div style={{fontFamily: 'Segoe UI',fontStyle: "normal",fontWeight: 600,fontSize: "16px",lineHeight: "21px",color: "#000000",marginBottom:"1rem"}}>RSS based Post Campaigns</div>
                        <div><ChatIcon style={{marginBottom:"1rem",color:'#638CE8',height:"92px",width:"92px"}}/></div>
                        <div style={{fontFamily: 'Montserrat',fontStyle: "normal",fontWeight: 400,fontSize: "10px",color: "#282828",marginBottom:"1rem"}} >Get periodic blog updates and post them to
                            social media.</div>
                    </div>
